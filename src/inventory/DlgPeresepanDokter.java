...
public final class DlgPeresepanDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel14.setText("Peresep :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 72, 72, 23);

        jLabel15.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 0, 0), 1, true));
        jLabel15.setForeground(new java.awt.Color(255, 51, 51));
        jLabel15.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel15.setText("Klik keyboard arah kanan( -> ) di kolom Aturan Pakai untuk memilih aturan pakai");
        jLabel15.setName("jLabel15"); // NOI18N
        FormInput.add(jLabel15);
        jLabel15.setBounds(700, 73, 400, 30);
...
//        else if(tbResep.getValueAt(tbResep.getSelectedRow(),8).toString().length()==0){
//            JOptionPane.showMessageDialog(null,"Maaf, Masih terdapat obat yang tidak ada aturan pakai"
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                if(ubah==false){
                    if(Sequel.menyimpantf2("resep_obat","?,?,?,?,?,?,?,?,?,?,?","Nomer Resep",11,new String[]{
                        NoResep.getText(),"0000-00-00","00:00:00",TNoRw.getText(),KdDokter.getText(),akses.getkode(),Valid.SetTgl(DTPBeri.getSelectedItem()+""),
