...
public class InventoryStokAkhirFarmasiPerTanggal extends javax.swing.JDialog {
    ...
    private double stokawal=0,s1=0,s2=0,s3=0,s4=0,s5=0,s6=0,s7=0,s8=0,s9=0,s10=0,s11=0,s12=0,s13=0,s14=0,s15=0,s16=0,s17=0,s18=0,s19=0,s20=0,
                   s21=0,s22=0,s23=0,s24=0,s25=0,s26=0,s27=0,s28=0,s29=0,s30=0,s31=0;
            ...
            try {            
                ...
                switch (pilihan) {
                    case "Laporan 1 (HTML)":
                            ...
                            htmlContent.append(                             
                                "<tr class='isi'>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='85px'>Kode Barang</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='190px'>Nama Barang</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>1("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),1)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>2("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),2)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>3("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),3)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>4("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),4)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>5("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),5)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>6("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),6)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>7("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),7)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>8("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),8)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>9("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),9)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>10("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),10)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>11("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),11)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>12("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),12)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>13("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),13)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>14("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),14)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>15("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),15)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>16("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),16)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>17("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),17)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>18("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),18)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>19("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),19)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>20("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),20)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>21("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),21)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>22("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),22)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>23("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),23)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>24("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),24)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>25("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),25)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>26("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),26)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>27("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),27)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>28("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),28)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>29("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),29)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>30("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),30)+")</td>"+
                                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='63px'>31("+konversi(Integer.parseInt(ThnCari.getSelectedItem().toString()),Integer.parseInt(BlnCari.getSelectedItem().toString()),31)+")</td>"+
                                "</tr>"
                            ); 
