    ...
    */
        ...
        try{        
            ...
            try {
                ...
                while(rsakunbayar.next()){
                    ...
                    kolom2++;
                    htmlContent.append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='130px'>"+rsakunbayar.getString("nm_rek")+"</td>");
                }
            } catch (Exception e) {
                System.out.println("Akun Bayar : "+e);
            } finally{
            ...
            for(i=0;i<kolom2;i++){
                htmlContent.append("<td valign='middle' align='right'>"+Valid.SetAngka(totalbayar2[i])+"</td>"); 
            }
            htmlContent.append( 
                "</tr>"
            ); 
    ...
    private void tampil2(){
        ...
        try{        
            ...
            for(i=0;i<kolom2;i++){
                htmlContent.append("<td valign='middle' align='right'>"+Math.round(totalbayar2[i])+"</td>"); 
            }
            htmlContent.append( 
                "</tr>"
            ); 
