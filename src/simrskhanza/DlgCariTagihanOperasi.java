...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    private String Suspen_Piutang_Operasi_Ranap="",Operasi_Ranap="",Beban_Jasa_Medik_Dokter_Operasi_Ranap="",Utang_Jasa_Medik_Dokter_Operasi_Ranap="",
            ...
            status="",tanggal="",mem="",norawat="",sql="",diagnosa_preop="",diagnosa_postop="",jaringan_dieksekusi="",prosedur="",selesaioperasi="",permintaan_pa="",laporan_operasi="",
            finger="",kodeoperator="";
    ...
    public DlgCariTagihanOperasi(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                ...
                "","","","","Diagnosa Pre-operatif","Diagnosa Post-operatif","Jaringan Yang di-Eksisi/-Insisi","Prosedur Tindakan Operasi","Kirim PA","Selesai Operasi",
                "Laporan Operasi"
            }){
    ...
    private void initComponents() {
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Operator & Paramedis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Laporan Operasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Scroll3.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1), "Laporan :", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel9.setBounds(10, 290, 200, 23);

        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel10.setText("Prosedur Tindakan Operasi :");
        jLabel10.setName("jLabel10"); // NOI18N
        panelGlass7.add(jLabel10);
        jLabel10.setBounds(10, 230, 200, 23);
        ...
        panelGlass7.add(ProsedurOperasi);
        ProsedurOperasi.setBounds(30, 260, 256, 23);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Tagihan Operasi/VK ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                ...
                param.put("ruang",Sequel.cariIsi("select ruang_ok.nm_ruang_ok from ruang_ok inner join booking_operasi on booking_operasi.kd_ruang_ok=ruang_ok.kd_ruang_ok where booking_operasi.no_rawat=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()));
                param.put("prosedur",Sequel.cariIsi("select prosedur from laporan_operasi where laporan_operasi.no_rawat=?",tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString()));
    ...
    private void MnUbahLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUbahLaporanActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                try {
                    rs2=koneksi.prepareStatement(
                        "select diagnosa_preop, diagnosa_postop, jaringan_dieksekusi, prosedur, selesaioperasi, permintaan_pa, laporan_operasi from laporan_operasi "+
                    ...
                    if(rs2.next()){
                        ...
                        ProsedurOperasi.setText(rs2.getString("prosedur"));
    ...
    private void prosesCari(String sql) {
       Valid.tabelKosong(tabMode);
        try{
            ...
            while(rs.next()){
                total=0;
                diagnosa_preop="";diagnosa_postop="";jaringan_dieksekusi="";prosedur="";selesaioperasi="";permintaan_pa="";laporan_operasi="";
                rs2=koneksi.prepareStatement(
                        "select diagnosa_preop, diagnosa_postop, jaringan_dieksekusi, prosedur, selesaioperasi, permintaan_pa, laporan_operasi "+
                ...
                if(rs2.next()){
                    ...
                    prosedur=rs2.getString("prosedur");
                ...
                tabMode.addRow(new Object[]{
                    ...
                    diagnosa_preop,diagnosa_postop,jaringan_dieksekusi,prosedur,permintaan_pa,selesaioperasi,laporan_operasi
                });     
                rs2=koneksi.prepareStatement(
                        "select operasi.operator1, operasi.operator2, operasi.operator3, operasi.asisten_operator1,"+
                        "operasi.asisten_operator2,operasi.asisten_operator3, operasi.instrumen, operasi.dokter_anak, operasi.perawaat_resusitas, "+
