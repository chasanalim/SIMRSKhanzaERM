...
//                            kddokter.requestFocus();
    ...
    private void initComponents() {
        ...
        DTPCari3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-05-2023" }));
        ...
        DTPCari4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-05-2023" }));
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
               ...
               "left join dpjp_ranap on kamar_inap.no_rawat=dpjp_ranap.no_rawat left join dokter on dokter.kd_dokter = dpjp_ranap.kd_dokter where "+key+" group by kamar_inap.no_rawat "+order );
            try {
                rs=ps.executeQuery();
                while(rs.next()){
