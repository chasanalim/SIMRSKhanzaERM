...
public final class DlgRawatJalan extends javax.swing.JDialog {
    private final DefaultTableModel tabModeDr,tabModePr,tabModeDrPr,
            ...
            TabModeTindakan,TabModeTindakan2,TabModeTindakan3,TabModeCatatan,TabModePRMRJ,tabModePemeriksaanSbar;
    ...
    public DlgRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModePemeriksaan=new DefaultTableModel(null,new Object[]{
            ...
            "Imun Ke","Plan","Asesmen","Instruksi","Evaluasi"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
        ...
        TabModePRMRJ=new DefaultTableModel(null,new Object[]{
            "P","No.Rawat","No.R.M.","Nama Pasien","Tanggal","Jam","Kode Dokter","Nama Dokter","Riwayat Alergi","Riwayat Penyakit","Riwayat Operasi","Terapi"}){
             @Override public boolean isCellEditable(int rowIndex, int colIndex){
                boolean a = false;
                if (colIndex==0) {
                    a=true;
    ...
    private void initComponents() {
        ...
        TBAlergi = new widget.TextArea();
        jLabel86 = new widget.Label();
        scrollPane9 = new widget.ScrollPane();
        TBRPenyakit = new widget.TextArea();
        ...
        TBROperasi = new widget.TextArea();
        ...
        JudulAsessmenMedis = new widget.Button();
        ...
        BtnFormFisioterapi = new widget.Button();
        BtnProgramTerapi = new widget.Button();
        ...
        JudulOperasi = new widget.Button();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Perawatan/Tindakan Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbPRMRJ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPRMRJKeyReleased(evt);
            }
        });
        Scroll12.setViewportView(tbPRMRJ);
        ...
        PanelInput4.setPreferredSize(new java.awt.Dimension(192, 153));
        ...
        panelGlass16.setPreferredSize(new java.awt.Dimension(44, 100));
        panelGlass16.setLayout(null);

        jLabel58.setText("Riwayat Alergi : ");
        jLabel58.setName("jLabel58"); // NOI18N
        panelGlass16.add(jLabel58);
        jLabel58.setBounds(0, 40, 110, 23);

        jLabel69.setText("Riwayat Penyakit : ");
        jLabel69.setName("jLabel69"); // NOI18N
        panelGlass16.add(jLabel69);
        jLabel69.setBounds(0, 90, 110, 23);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane5.setName("scrollPane5"); // NOI18N

        TBAlergi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TBAlergi.setColumns(20);
        TBAlergi.setRows(5);
        ...
        scrollPane5.setViewportView(TBAlergi);

        panelGlass16.add(scrollPane5);
        scrollPane5.setBounds(110, 40, 320, 38);

        jLabel86.setText("Terapi : ");
        jLabel86.setName("jLabel86"); // NOI18N
        panelGlass16.add(jLabel86);
        jLabel86.setBounds(470, 90, 90, 23);

        scrollPane9.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane9.setName("scrollPane9"); // NOI18N

        TBRPenyakit.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TBRPenyakit.setColumns(20);
        TBRPenyakit.setRows(5);
        TBRPenyakit.setName("TBRPenyakit"); // NOI18N
        TBRPenyakit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TBRPenyakitKeyPressed(evt);
            }
        });
        scrollPane9.setViewportView(TBRPenyakit);

        panelGlass16.add(scrollPane9);
        scrollPane9.setBounds(110, 90, 320, 38);

        scrollPane10.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane10.setName("scrollPane10"); // NOI18N

        TBTerapi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TBTerapi.setColumns(20);
        TBTerapi.setRows(5);
        TBTerapi.setName("TBTerapi"); // NOI18N
        TBTerapi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TBTerapiKeyPressed(evt);
            }
        });
        scrollPane10.setViewportView(TBTerapi);

        panelGlass16.add(scrollPane10);
        scrollPane10.setBounds(560, 90, 320, 38);
        ...
        jLabel90.setBounds(450, 10, 190, 23);

        Btn5Soap1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        Btn5Soap1.setMnemonic('4');
        Btn5Soap1.setToolTipText("ALt+4");
        ...
        panelGlass16.add(Btn5Soap1);
        Btn5Soap1.setBounds(850, 10, 28, 23);

        scrollPane14.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane14.setName("scrollPane14"); // NOI18N

        TBROperasi.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        TBROperasi.setColumns(20);
        TBROperasi.setRows(5);
        TBROperasi.setName("TBROperasi"); // NOI18N
        TBROperasi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TBROperasiKeyPressed(evt);
            }
        });
        scrollPane14.setViewportView(TBROperasi);

        panelGlass16.add(scrollPane14);
        scrollPane14.setBounds(560, 40, 320, 38);

        jLabel70.setText("Riwayat Operasi : ");
        jLabel70.setName("jLabel70"); // NOI18N
        panelGlass16.add(jLabel70);
        jLabel70.setBounds(450, 40, 110, 23);

        PanelInput4.add(panelGlass16, java.awt.BorderLayout.CENTER);

        internalFrame9.add(PanelInput4, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("PRMRJ", internalFrame9);

        internalFrame10.setBackground(new java.awt.Color(235, 255, 235));
        internalFrame10.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        ...
        Scroll13.setViewportView(tbPemeriksaanSbar);

        internalFrame10.add(Scroll13, java.awt.BorderLayout.CENTER);
        ...
        scrollPane11.setViewportView(TSituation);

        panelGlass17.add(scrollPane11);
        scrollPane11.setBounds(70, 50, 360, 70);
        ...
        scrollPane12.setViewportView(TBackground);

        panelGlass17.add(scrollPane12);
        scrollPane12.setBounds(70, 130, 360, 70);
        ...
        jLabel91.setText("Background :");
        jLabel91.setName("jLabel91"); // NOI18N
        panelGlass17.add(jLabel91);
        jLabel91.setBounds(0, 130, 70, 23);
        ...
        scrollPane13.setViewportView(TAssesment);

        panelGlass17.add(scrollPane13);
        scrollPane13.setBounds(550, 50, 360, 70);

        jLabel92.setText("Asesmen :");
        jLabel92.setName("jLabel92"); // NOI18N
        panelGlass17.add(jLabel92);
        jLabel92.setBounds(450, 50, 90, 23);

        jLabel93.setText("Recommendation :");
        jLabel93.setName("jLabel93"); // NOI18N
        panelGlass17.add(jLabel93);
        jLabel93.setBounds(450, 130, 90, 23);
        ...
        scrollPane15.setViewportView(TRecommendation);

        panelGlass17.add(scrollPane15);
        scrollPane15.setBounds(550, 130, 360, 70);

        jLabel94.setText("Dilakukan :");
        jLabel94.setName("jLabel94"); // NOI18N
        panelGlass17.add(jLabel94);
        jLabel94.setBounds(0, 10, 70, 23);
        ...
        panelGlass17.add(BtnSeekPegawai2);
        BtnSeekPegawai2.setBounds(400, 10, 28, 23);
        ...
        jLabel95.setText("Profesi / Jabatan / Departemen :");
        jLabel95.setName("jLabel95"); // NOI18N
        panelGlass17.add(jLabel95);
        jLabel95.setBounds(440, 10, 190, 23);
        ...
        panelGlass17.add(jLabel87);
        jLabel87.setBounds(800, 210, 200, 23);
        ...
        internalFrame10.add(PanelInput5, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("SBAR", internalFrame10);
        ...
        jLabel3.setBounds(910, 10, 90, 23);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(202, 10, 60, 23);

        TPasien.setEditable(false);
        TPasien.setHighlighter(null);
        TPasien.setName("TPasien"); // NOI18N
        FormInput.add(TPasien);
        TPasien.setBounds(265, 10, 270, 23);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-03-2024" }));
        ...
        ChkJln.setBounds(870, 10, 23, 23);

        LblCatatan.setBackground(new java.awt.Color(255, 204, 153));
        ...
        LblCatatan.setBounds(1000, 5, 500, 30);

        jLabel61.setText("No.Rawat :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(0, 10, 70, 23);
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(150, 500));
        ...
        BtnRiwayat.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulFarmasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulFarmasiActionPerformed(evt);
            }
        });
        ...
        BtnResepLuar.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulPenunjang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulPenunjangActionPerformed(evt);
            }
        });
        ...
        BtnPeriksaRad.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnPeriksaRad.setText("Pemeriksaan Radiologi");
        BtnPeriksaRad.setFocusPainted(false);
        BtnPeriksaRad.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPeriksaRad.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnPeriksaRad.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPeriksaRad.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnPeriksaRad.setName("BtnPeriksaRad"); // NOI18N
        BtnPeriksaRad.setPreferredSize(new java.awt.Dimension(170, 23));
        BtnPeriksaRad.setRoundRect(false);
        BtnPeriksaRad.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPeriksaRadActionPerformed(evt);
            }
        });
        FormMenu.add(BtnPeriksaRad);
        ...
        BtnMedicalCheckUp.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnUjiFungsiKFR.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulAsessmenMedis.setBackground(new java.awt.Color(252, 230, 230));
        JudulAsessmenMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        JudulAsessmenMedis.setText("Asessmen Medis Rajal");
        JudulAsessmenMedis.setFocusPainted(false);
        JudulAsessmenMedis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        JudulAsessmenMedis.setGlassColor(new java.awt.Color(255, 255, 255));
        JudulAsessmenMedis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        JudulAsessmenMedis.setMargin(new java.awt.Insets(1, 1, 1, 1));
        JudulAsessmenMedis.setName("JudulAsessmenMedis"); // NOI18N
        JudulAsessmenMedis.setOpaque(true);
        JudulAsessmenMedis.setPreferredSize(new java.awt.Dimension(180, 23));
        JudulAsessmenMedis.setRoundRect(false);
        JudulAsessmenMedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulAsessmenMedisActionPerformed(evt);
            }
        });
        FormMenu.add(JudulAsessmenMedis);
        ...
        BtnCatatanObservasiIGD.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisIGD.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisIGDPsikiatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisAnak.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisBedah.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisBedahMulut.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisRehabMedik.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisGeriatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisKulitKelamin.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisMata.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisNeurologi.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisOrthopedi.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisPenyakitDalam.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisPsikiatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalMedisTHT.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulAsessmen.setText("Asessmen Perawat Rajal/IGD");
        ...
        JudulAsessmen.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulAsessmenActionPerformed(evt);
            }
        });
        ...
        BtnTriaseIGD.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalKeperawatanIGD.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalKeperawatanGeriatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalKeperawatanGigi.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalKeperawatanPsikiatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnAwalKeperawatan.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnFormFisioterapi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnFormFisioterapi.setText("Fisioterapi -  Form Klaim Fisioterapi");
        BtnFormFisioterapi.setFocusPainted(false);
        BtnFormFisioterapi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnFormFisioterapi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnFormFisioterapi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnFormFisioterapi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnFormFisioterapi.setName("BtnFormFisioterapi"); // NOI18N
        BtnFormFisioterapi.setPreferredSize(new java.awt.Dimension(170, 23));
        BtnFormFisioterapi.setRoundRect(false);
        BtnFormFisioterapi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnFormFisioterapiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnFormFisioterapi);

        BtnProgramTerapi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnProgramTerapi.setText("Fisioterapi - Program Terapi");
        BtnProgramTerapi.setFocusPainted(false);
        BtnProgramTerapi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnProgramTerapi.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnProgramTerapi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnProgramTerapi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnProgramTerapi.setName("BtnProgramTerapi"); // NOI18N
        BtnProgramTerapi.setPreferredSize(new java.awt.Dimension(170, 23));
        BtnProgramTerapi.setRoundRect(false);
        BtnProgramTerapi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnProgramTerapiActionPerformed(evt);
            }
        });
        FormMenu.add(BtnProgramTerapi);
        ...
        JudulAsessmenLain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulAsessmenLainActionPerformed(evt);
            }
        });
        ...
        BtnPenilaianPasienKeracunan.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulEWS.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulEWSActionPerformed(evt);
            }
        });
        ...
        JudulGizi.setBackground(new java.awt.Color(252, 230, 230));
        JudulGizi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        JudulGizi.setText("Gizi");
        JudulGizi.setFocusPainted(false);
        JudulGizi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        JudulGizi.setGlassColor(new java.awt.Color(255, 255, 255));
        JudulGizi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        JudulGizi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        JudulGizi.setName("JudulGizi"); // NOI18N
        JudulGizi.setOpaque(true);
        JudulGizi.setPreferredSize(new java.awt.Dimension(180, 23));
        JudulGizi.setRoundRect(false);
        JudulGizi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulGiziActionPerformed(evt);
            }
        });
        FormMenu.add(JudulGizi);
        ...
        JudulOperasi.setBackground(new java.awt.Color(252, 230, 230));
        JudulOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        JudulOperasi.setText("Operasi");
        JudulOperasi.setFocusPainted(false);
        JudulOperasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        JudulOperasi.setGlassColor(new java.awt.Color(255, 255, 255));
        JudulOperasi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        JudulOperasi.setMargin(new java.awt.Insets(1, 1, 1, 1));
        JudulOperasi.setName("JudulOperasi"); // NOI18N
        JudulOperasi.setOpaque(true);
        JudulOperasi.setPreferredSize(new java.awt.Dimension(180, 23));
        JudulOperasi.setRoundRect(false);
        JudulOperasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulOperasiActionPerformed(evt);
            }
        });
        FormMenu.add(JudulOperasi);
        ...
        JudulRekamMedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulRekamMedisActionPerformed(evt);
            }
        });
        ...
        BtnEdukasiPasienKeluarga.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnRujukInternal.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnSKDP.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulResikoJatuh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulResikoJatuhActionPerformed(evt);
            }
        });
        ...
        BtnPenilaianLanjutanRisikoJatuhAnak.setText("Risiko Jatuh Anak");
        ...
        BtnPenilaianLanjutanRisikoJatuhAnak.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanRisikoJatuhDewasa.setText("Risiko Jatuh Dewasa");
        ...
        BtnPenilaianLanjutanRisikoJatuhDewasa.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setText("Risiko Jatuh Geriatri");
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanRisikoJatuhLansia.setText("Risiko Jatuh Lansia");
        ...
        BtnPenilaianLanjutanRisikoJatuhLansia.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setText("Risiko Jatuh Neonatus");
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setText("Risiko Jatuh Psikiatri");
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        BtnPenilaianLanjutanSkriningFungsional.setText("Skrining Fungsional");
        ...
        BtnPenilaianLanjutanSkriningFungsional.setPreferredSize(new java.awt.Dimension(170, 23));
        ...
        JudulLain.setBackground(new java.awt.Color(252, 230, 230));
        JudulLain.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/kanan.png"))); // NOI18N
        JudulLain.setText("Lain - lain");
        JudulLain.setFocusPainted(false);
        JudulLain.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        JudulLain.setGlassColor(new java.awt.Color(255, 255, 255));
        JudulLain.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        JudulLain.setMargin(new java.awt.Insets(1, 1, 1, 1));
        JudulLain.setName("JudulLain"); // NOI18N
        JudulLain.setOpaque(true);
        JudulLain.setPreferredSize(new java.awt.Dimension(180, 23));
        JudulLain.setRoundRect(false);
        JudulLain.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                JudulLainActionPerformed(evt);
            }
        });
        FormMenu.add(JudulLain);
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.menyimpantf("pemeriksaan_ralan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",21,new String[]{
                                    ...
                                    LingkarPerut.getText(),TindakLanjut.getText(),TPenilaian.getText(),TInstruksi.getText(),TEvaluasi.getText(),KdPeg.getText()})==true){
                                        ...
                                        TEvaluasi.setText("");cmbKesadaran.setSelectedIndex(0);tampilPemeriksaan();
...
//                            }
                ...
                case 7:
                    ...
                    break;
                case 8:
                    if((!TBAlergi.getText().trim().equals(""))||(!TBRPenyakit.getText().trim().equals(""))||(!TBROperasi.getText().trim().equals(""))||(!TBTerapi.getText().trim().equals(""))){
                        if(Sequel.menyimpantf("prmrj","?,?,?,?,?,?,?,?","Data",8,new String[]{
                             TNoRw.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),cmbJam.getSelectedItem()+":"+cmbMnt.getSelectedItem()+":"+cmbDtk.getSelectedItem(),
                                    TBAlergi.getText(),TBRPenyakit.getText(),TBROperasi.getText(),TBTerapi.getText(),KdPeg.getText()
                        })==true){
                            TBAlergi.setText("");TBRPenyakit.setText("");TBROperasi.setText("");TBTerapi.setText("");
                            tampilPRMRJ();
                        }
                    }
                    break;
                            ...
                            if(akses.getkode().equals("Admin Utama")){
                                if(Sequel.mengedittf("pemeriksaan_ralan","no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1)+
                                    ...
                                    "instruksi='"+TInstruksi.getText()+"',evaluasi='"+TEvaluasi.getText()+"',nip='"+KdPeg.getText()+"'")==true){
                                        ...
                                        SpO2.setText("");TEvaluasi.setText("");tampilPemeriksaan();
                                }   
                            }else{
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void KdDok3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KdDok3KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select dokter.nm_dokter from dokter where dokter.kd_dokter=?",TDokter3,KdDok3.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
...
//        dokter.isCek();
    ...
    private void tbPRMRJKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPRMRJKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_tbPRMRJKeyReleased
    ...
    private void TBRPenyakitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBRPenyakitKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TBRPenyakitKeyPressed

    private void TBTerapiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBTerapiKeyPressed
        // TODO add your handling code here:
    ...
    private void Btn5Soap1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn5Soap1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Btn5Soap1ActionPerformed

    private void TBROperasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBROperasiKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TBROperasiKeyPressed
    ...
    private void BtnProgramTerapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnProgramTerapiActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnProgramTerapiActionPerformed

    private void BtnFormFisioterapiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnFormFisioterapiActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    }//GEN-LAST:event_BtnFormFisioterapiActionPerformed
    ...
    private void BtnSKDPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSKDPActionPerformed
        if(TNoRw.getText().trim().equals("")){
            ...
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                ...
                form.setLocationRelativeTo(internalFrame1);
                form.emptTeks();
                form.setNoRm(TNoRw.getText(),TNoRM.getText(),TPasien.getText(), kode_poli,Sequel.cariIsi("select poliklinik.nm_poli from poliklinik where poliklinik.kd_poli=?",kode_poli),KdDok.getText(),TDokter.getText());
                form.setVisible(true);
            }
        }
    ...
    private void JudulAsessmenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulAsessmenActionPerformed

    }//GEN-LAST:event_JudulAsessmenActionPerformed

    private void JudulAsessmenLainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulAsessmenLainActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulAsessmenLainActionPerformed

    private void JudulRekamMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulRekamMedisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulRekamMedisActionPerformed

    private void JudulEWSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulEWSActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulEWSActionPerformed

    private void JudulFarmasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulFarmasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulFarmasiActionPerformed

    private void JudulGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulGiziActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulGiziActionPerformed

    private void JudulOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulOperasiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulOperasiActionPerformed

    private void JudulPenunjangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulPenunjangActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulPenunjangActionPerformed

    private void JudulResikoJatuhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulResikoJatuhActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulResikoJatuhActionPerformed

    private void JudulAsessmenMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulAsessmenMedisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_JudulAsessmenMedisActionPerformed

    private void JudulLainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JudulLainActionPerformed
        // TODO add your handling code here:
    ...
    private void BtnPeriksaRadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPeriksaRadActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    */
    ...
    private widget.Button BtnProgramTerapi;
    ...
    private widget.Button JudulAsessmenMedis;
    private widget.Button JudulEWS;
    private widget.Button JudulFarmasi;
    private widget.Button JudulGizi;
    ...
    private widget.TextArea TBAlergi;
    private widget.TextArea TBROperasi;
    private widget.TextArea TBRPenyakit;
    private widget.TextArea TBTerapi;
    ...
    public void setNoRm(String norwt,Date tgl1,Date tgl2) {
        ...
        } else if((Jabatan.getText().trim().contains("Gigi"))||(Jabatan.getText().trim().contains("Bedah Mulut"))){
        ...
        Sequel.cariIsi("select gcs from penilaian_awal_keperawatan_gigi where no_rawat=?",TGCS,TNoRw.getText());
        ...
        } else if(Jabatan.getText().trim().contains("Anak")){
        ...
        Sequel.cariIsi("select gcs from penilaian_awal_keperawatan_ralan_bayi where no_rawat=?",TGCS,TNoRw.getText());
        ...
        } else if(Jabatan.getText().trim().contains("IGD")){
        Sequel.cariIsi("select keluhan_utama from data_triase_igdprimer where no_rawat=?",TKeluhan,TNoRw.getText());
//        Sequel.cariIsi("select anamnesa_singkat from data_triase_igdsekunder where no_rawat=?",TKeluhan,TNoRw.getText());
        Sequel.cariIsi("select tekanan_darah from data_triase_igd where no_rawat=?",TTensi,TNoRw.getText());
        Sequel.cariIsi("select nadi from data_triase_igd where no_rawat=?",TNadi,TNoRw.getText());
        Sequel.cariIsi("select pernapasan from data_triase_igd where no_rawat=?",TRespirasi,TNoRw.getText());
        Sequel.cariIsi("select suhu from data_triase_igd where no_rawat=?",TSuhu,TNoRw.getText());
        Sequel.cariIsi("select saturasi_o2 from data_triase_igd where no_rawat=?",SpO2,TNoRw.getText());
        } else {
...
//        }
    ...
    private void tampilPemeriksaan() {
        ...
        try{  
            ps4=koneksi.prepareStatement("select pemeriksaan_ralan.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"+
                    "pemeriksaan_ralan.tgl_perawatan,pemeriksaan_ralan.jam_rawat,pemeriksaan_ralan.nip,pegawai.nama,pegawai.jbtn,pemeriksaan_ralan.suhu_tubuh,pemeriksaan_ralan.tensi, " +
                    "pemeriksaan_ralan.nadi,pemeriksaan_ralan.respirasi,pemeriksaan_ralan.tinggi, " +
                    "pemeriksaan_ralan.berat,pemeriksaan_ralan.spo2,pemeriksaan_ralan.gcs,pemeriksaan_ralan.kesadaran,pemeriksaan_ralan.keluhan, " +
                    "pemeriksaan_ralan.pemeriksaan,pemeriksaan_ralan.alergi,pemeriksaan_ralan.lingkar_perut,pemeriksaan_ralan.rtl,"+
                    "pemeriksaan_ralan.penilaian,pemeriksaan_ralan.instruksi,pemeriksaan_ralan.evaluasi "+
                    "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pemeriksaan_ralan on pemeriksaan_ralan.no_rawat=reg_periksa.no_rawat "+
                    "inner join pegawai on pemeriksaan_ralan.nip=pegawai.nik where  "+
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            LingkarPerut.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),21).toString()); 
            TindakLanjut.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),22).toString()); 
            TPenilaian.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),23).toString()); 
            TInstruksi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),24).toString()); 
            TEvaluasi.setText(tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),25).toString()); 
    ...
    private void tampilPRMRJ() {
       Valid.tabelKosong(TabModePRMRJ);
        try{
            ps5=koneksi.prepareStatement("SELECT prmrj.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,prmrj.tgl_perawatan,prmrj.jam_rawat,prmrj.riwayat_alergi,prmrj.riwayat_operasi,prmrj.riwayat_penyakit,prmrj.terapi,prmrj.nip,dokter.nm_dokter " +
            "FROM pasien INNER JOIN reg_periksa on reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN prmrj ON prmrj.no_rawat=reg_periksa.no_rawat INNER JOIN dokter on prmrj.nip=dokter.kd_dokter " +
            "WHERE prmrj.tgl_perawatan BETWEEN ? AND ? AND reg_periksa.no_rkm_medis LIKE ? AND prmrj.no_rawat LIKE ? OR  prmrj.tgl_perawatan BETWEEN ? AND ? " +
            "AND reg_periksa.no_rkm_medis LIKE ? AND reg_periksa.no_rkm_medis LIKE ? OR  prmrj.tgl_perawatan BETWEEN ? AND ? AND reg_periksa.no_rkm_medis LIKE ? AND pasien.nm_pasien LIKE ? " +
            "ORDER BY prmrj.no_rawat,prmrj.tgl_perawatan,prmrj.jam_rawat DESC");
            try {
                ps5.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                ps5.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                ps5.setString(3,"%"+TCariPasien.getText()+"%");
                ...
                rs=ps5.executeQuery();
                while(rs.next()) {
                    TabModePRMRJ.addRow(new Object[] {
                        false,rs.getString("no_rawat"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("nip"),rs.getString("nm_dokter"),rs.getString("riwayat_alergi"),
                        rs.getString("riwayat_penyakit"),rs.getString("riwayat_operasi"),rs.getString("terapi")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : "+e);    
    ...
    private void isForm5() {
       if(ChkInput4.isSelected()==true){
            ...
            PanelInput4.setPreferredSize(new Dimension(WIDTH,153));
