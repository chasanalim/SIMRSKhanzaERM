...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    private String kodekamar="",namakamar="",tglkeluar="",jamkeluar="",finger="",aktifjadwal="";
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Ket.Dilanjutkan","Kontrol Kembali","Obat Pulang","Kode Bayar","Cara Bayar","No Surat","Kd Dokter","Dokter","kd Poli","Poliklinik"
        }){
        ...
        skdp.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(skdp.getTable().getSelectedRow()!= -1){                   
                    NoSurat.setText(skdp.getTable().getValueAt(skdp.getTable().getSelectedRow(),9).toString());
//                    Diagnosa.setText(skdp.getTable().getValueAt(skdp.getTable().getSelectedRow(),7).toString());   
...
//                    isNomer();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Resume Medis Pasien Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1242));
        ...
        jLabel37.setBounds(410, 1110, 70, 23);
        ...
        CaraKeluar.setBounds(489, 1110, 150, 23);

        jLabel36.setText("Keadaan Pulang :");
        jLabel36.setName("jLabel36"); // NOI18N
        FormInput.add(jLabel36);
        jLabel36.setBounds(0, 1110, 100, 23);
        ...
        Keadaan.setBounds(110, 1110, 130, 23);
        ...
        KetKeluar.setBounds(650, 1110, 140, 23);
        ...
        KetKeadaanPulang.setBounds(250, 1110, 150, 23);

        jLabel42.setText("Dilanjutkan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 1140, 100, 23);
        ...
        DIlanjutkan.setBounds(110, 1140, 130, 23);
        ...
        KetDilanjutkan.setBounds(250, 1140, 150, 23);

        Kontrol.setForeground(new java.awt.Color(50, 70, 50));
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-11-2023 09:17:08" }));
        ...
        Kontrol.setBounds(110, 1170, 135, 23);

        label13.setBackground(new java.awt.Color(255, 255, 255));
        label13.setForeground(new java.awt.Color(255, 102, 102));
        label13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        label13.setText("* isi - jika pasien tidak kontrol");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label13);
        label13.setBounds(250, 1170, 160, 23);

        label16.setText("Obat Pulang :");
        label16.setName("label16"); // NOI18N
        label16.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label16);
        label16.setBounds(0, 1050, 100, 23);
        ...
        scrollPane11.setBounds(105, 1050, 681, 50);
        ...
        BtnDokter19.setBounds(70, 1080, 28, 23);
        ...
        jLabel14.setBounds(440, 1170, 40, 23);

        NmDokter.setHighlighter(null);
        NmDokter.setName("NmDokter"); // NOI18N
        FormInput.add(NmDokter);
        NmDokter.setBounds(540, 1170, 220, 23);

        KdDokter.setHighlighter(null);
        KdDokter.setName("KdDokter"); // NOI18N
        FormInput.add(KdDokter);
        KdDokter.setBounds(485, 1170, 50, 23);

        BtnDokter4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokter4.setMnemonic('X');
        BtnDokter4.setToolTipText("Alt+X");
        ...
        BtnDokter4.setBounds(760, 1170, 28, 23);

        jLabel44.setText("Unit/Poli :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(430, 1200, 50, 23);

        KdPoli.setEditable(false);
        KdPoli.setHighlighter(null);
        KdPoli.setName("KdPoli"); // NOI18N
        FormInput.add(KdPoli);
        KdPoli.setBounds(485, 1200, 50, 23);

        NmPoli.setEditable(false);
        NmPoli.setHighlighter(null);
        NmPoli.setName("NmPoli"); // NOI18N
        FormInput.add(NmPoli);
        NmPoli.setBounds(540, 1200, 220, 23);
        ...
        BtnPoli.setBounds(760, 1200, 28, 23);
        ...
        NoSurat.setBounds(110, 1200, 260, 24);
        ...
        BtnSKDP.setBounds(370, 1200, 28, 23);

        jLabel43.setText("No. Surat VClaim:");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(10, 1200, 90, 23);

        label17.setText("Tanggal  Kontrol :");
        label17.setName("label17"); // NOI18N
        label17.setPreferredSize(new java.awt.Dimension(70, 23));
        FormInput.add(label17);
        label17.setBounds(10, 1170, 90, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("resume_pasien_ranap","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",46,new String[]{
                    ...
                    Valid.SetTgl(Kontrol.getSelectedItem()+""),ObatPulang.getText(),
                    NoSurat.getText(),KdDokter.getText(),NmDokter.getText(),KdPoli.getText(),NmPoli.getText()
                })==true){
                    tampil();
                    emptTeks();
            }
    ...
    private void MnLaporanResumeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResumeActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("kontrol",tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());
    ...
    private void BtnDokter4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter4ActionPerformed
        if(aktifjadwal.equals("aktif")){
            if(akses.getkode().equals("Admin Utama")){
                ...
                dokter2.isCek();
                dokter2.SetHari(Kontrol.getDate());
                dokter2.tampil();
    ...
    private void BtnPoliKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPoliKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,BtnDokter,Kontrol);
        }
    ...
    public void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "resume_pasien_ranap.no_surat_kontrol,resume_pasien_ranap.kd_dokter_kontrol,resume_pasien_ranap.dokter_kontrol,resume_pasien_ranap.Kd_poli_kontrol,resume_pasien_ranap.poli_kontrol "+
                    "from resume_pasien_ranap inner join reg_periksa on resume_pasien_ranap.no_rawat=reg_periksa.no_rawat inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join dokter on resume_pasien_ranap.kd_dokter=dokter.kd_dokter inner join dokter as pengirim on reg_periksa.kd_dokter=pengirim.kd_dokter "+
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    ps2=koneksi.prepareStatement(
                        "select if(kamar_inap.tgl_keluar='0000-00-00',current_date(),kamar_inap.tgl_keluar) as tgl_keluar,"+
                        "if(kamar_inap.jam_keluar='00:00:00',current_time(),kamar_inap.jam_keluar) as jam_keluar,kamar_inap.kd_kamar,bangsal.nm_bangsal "+
                        "from reg_periksa INNER JOIN ranap_gabung ON ranap_gabung.no_rawat2 = reg_periksa.no_rawat "+
                        "INNER JOIN kamar_inap ON kamar_inap.no_rawat = ranap_gabung.no_rawat INNER JOIN kamar ON kamar_inap.kd_kamar = kamar.kd_kamar INNER JOIN bangsal ON kamar.kd_bangsal = bangsal.kd_bangsal "+
                    ...
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("obat_pulang"),rs.getString("kd_pj"),rs.getString("png_jawab"),rs.getString("no_surat_kontrol"),rs.getString("kd_dokter_kontrol"),
                        rs.getString("dokter_kontrol"),rs.getString("kd_poli_kontrol"),rs.getString("poli_kontrol")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
...
//            Kontrol.setText(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString()); 
            NoSurat.setText(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());  
            KdDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());  
            NmDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());  
            KdPoli.setText(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());  
            NmPoli.setText(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString());  
        }
    }
        ...
        try {
            ...
            try {
                ...
                if(rs.next()){
                    ...
                    Alasan.setText(Sequel.cariIsi("select catatan from perintah_ranap where no_rawat=?",TNoRw.getText()));
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
            } finally{
    ...
    private void isRawat2() {
        try {
            ps=koneksi.prepareStatement(
                    ...
                    "inner join dokter on dokter.kd_dokter=reg_periksa.kd_dokter "+
                    "inner join penjab on penjab.kd_pj=reg_periksa.kd_pj "+
                    "inner join ranap_gabung ON pasien.no_rkm_medis = reg_periksa.no_rkm_medis "+
    ...
    private void ganti() {
        if(Sequel.mengedittf("resume_pasien_ranap","no_rawat=?","no_rawat=?,kd_dokter=?,diagnosa_awal=?,alasan=?,keluhan_utama=?,pemeriksaan_fisik=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,"+
                ...
                "ket_keadaan=?,dilanjutkan=?,ket_dilanjutkan=?,kontrol=?,obat_pulang=?,no_surat_kontrol=?,kd_poli_kontrol=?,poli_kontrol=?,kd_dokter_kontrol=?,dokter_kontrol=?",47,new String[]{
                TNoRw.getText(),KodeDokter.getText(),DiagnosaAwal.getText(),Alasan.getText(),KeluhanUtama.getText(),PemeriksaanFisik.getText(),JalannyaPenyakit.getText(),
                PemeriksaanRad.getText(),HasilLaborat.getText(),TindakanSelamaDiRS.getText(),ObatSelamaDiRS.getText(),DiagnosaUtama.getText(),KodeDiagnosaUtama.getText(),
                DiagnosaSekunder1.getText(),KodeDiagnosaSekunder1.getText(),DiagnosaSekunder2.getText(),KodeDiagnosaSekunder2.getText(),DiagnosaSekunder3.getText(),
                KodeDiagnosaSekunder3.getText(),DiagnosaSekunder4.getText(),KodeDiagnosaSekunder4.getText(),ProsedurUtama.getText(),KodeProsedurUtama.getText(),
                ...
                KodeProsedurSekunder3.getText(),Alergi.getText(),Diet.getText(),LabBelum.getText(),Edukasi.getText(),CaraKeluar.getSelectedItem().toString(),KetKeluar.getText(),
                Keadaan.getSelectedItem().toString(),KetKeadaanPulang.getText(),DIlanjutkan.getSelectedItem().toString(),KetDilanjutkan.getText(),
                Valid.SetTgl(Kontrol.getSelectedItem()+""),ObatPulang.getText(),NoSurat.getText(),KdPoli.getText(),
                NmPoli.getText(),KdDokter.getText(),NmDokter.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                })==true){
                   tampil();
                   emptTeks();
            }
