 ...
 * @author perpustakaan
 */
public final class RMDataProgramTerapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMDataProgramTerapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        Program.setDocument(new batasInput((byte)150).getKata(Program));
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Program Terapi Fisioterapi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(100, 255));
        ...
        Diagnosa.setBounds(110, 70, 260, 23);

        jLabel23.setText("Permintaan Terapi :");
        ...
        KdPetugas.setBounds(450, 70, 94, 23);

        jLabel20.setText("Petugas :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(370, 70, 70, 23);

        NamaPetugas.setEditable(false);
        NamaPetugas.setName("NamaPetugas"); // NOI18N
        FormInput.add(NamaPetugas);
        NamaPetugas.setBounds(547, 70, 210, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("program_terapi","?,?,?,?,?,?,?,?","Data",8,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                Diagnosa.getText(),Terapi.getText(),Program.getText(),KdDokter.getText(),KdPetugas.getText()
            })==true){
                tampil();
                emptTeks();
            }   
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Program,BtnBatal);
        }
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(tbObat.getSelectedRow()>-1){
            if(akses.getkode().equals("Admin Utama")){
                ...
                if(KdDokter.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString())){
                    hapus();
                }else{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMDataProgramTerapi dialog = new RMDataProgramTerapi(new javax.swing.JFrame(), true);
    ...
    private void ganti() {
        Sequel.mengedit("program_terapi","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,diagnosa=?,terapi=?,program=?,kd_dokter=?,nip=?",11,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            Diagnosa.getText(),Terapi.getText(),Program.getText(),KdDokter.getText(),KdPetugas.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from program_terapi where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
