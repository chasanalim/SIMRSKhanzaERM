 ...
 * @author perpustakaan
 */
public final class RMFormFisioterapi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMFormFisioterapi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tgl.Pelayanan","Jam Pelayanan","Anamnesa",
            "Anjuran","Diagnosis (iCD 10)","Tindakan (ICD 9)","Evaluasi","Suspek","Ket Suspek","NIP","Nama Dokter"
        }){
        ...
        for (i = 0; i < 17; i++) {
            ...
            }else if(i==8){//Anamnesa
                column.setPreferredWidth(225);
            }else if(i==9){//Anjuran
                column.setPreferredWidth(225);
            }else if(i==10){//Diagnosa
                column.setPreferredWidth(225);
            }else if(i==11){//Tindakan
                column.setPreferredWidth(225);
            }else if(i==12){//Evaluasi
                column.setPreferredWidth(220);
            }else if(i==13){//Suspek
                column.setPreferredWidth(55);
            }else if(i==14){//Ket Suspek
                column.setPreferredWidth(150);
            }else if(i==15){//NIP
                column.setPreferredWidth(90);
            }else if(i==16){//Nama Dokter
                column.setPreferredWidth(160);
            }
        }
    ...
    private void initComponents() {
        ...
        jLabel18.setBounds(430, 40, 60, 23);
        ...
        jLabel12.setBounds(20, 70, 80, 23);
        ...
        Anamnesa.setBounds(110, 70, 260, 23);

        jLabel23.setText("Anjuran :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(0, 103, 100, 20);

        jLabel29.setText("Suspek Penyait Akibat Kerja :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(340, 130, 150, 23);

        Anjuran.setFocusTraversalPolicyProvider(true);
        ...
        Anjuran.setBounds(110, 100, 260, 23);

        KetSuspek.setFocusTraversalPolicyProvider(true);
        ...
        FormInput.add(KetSuspek);
        KetSuspek.setBounds(580, 130, 210, 23);

        jLabel30.setText("Diagnosis (ICD 10) :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(380, 70, 110, 23);
        ...
        Diagnosa.setBounds(500, 70, 290, 23);
        ...
        Evaluasi.setBounds(110, 130, 220, 23);

        jLabel24.setText("Evaluasi :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(0, 130, 100, 20);

        jLabel31.setText("Tindakan (ICD 9) :");
        jLabel31.setName("jLabel31"); // NOI18N
        FormInput.add(jLabel31);
        jLabel31.setBounds(380, 100, 110, 23);
        ...
        Tindakan.setBounds(500, 100, 290, 23);

        cmbSuspek.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak" }));
        cmbSuspek.setName("cmbSuspek"); // NOI18N
        cmbSuspek.setPreferredSize(new java.awt.Dimension(150, 23));
        FormInput.add(cmbSuspek);
        cmbSuspek.setBounds(500, 130, 70, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("form_fisioterapi","?,?,?,?,?,?,?,?,?,?,?","Data",11,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
                Anamnesa.getText(),Anjuran.getText(),Diagnosa.getText(),Tindakan.getText(),Evaluasi.getText(),cmbSuspek.getSelectedItem().toString(),KetSuspek.getText(),NIP.getText()
            })==true)
            {
    ...
    private void BtnSimpanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            Valid.pindah(evt,Anamnesa,BtnBatal);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMFormFisioterapi dialog = new RMFormFisioterapi(new javax.swing.JFrame(), true);
    ...
    private widget.ComboBox cmbSuspek;
        ...
        try{
            if(TCari.getText().toString().trim().equals("")){
                ps=koneksi.prepareStatement(
                    "SELECT reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur, "+
                    "pasien.jk,pasien.tgl_lahir,form_fisioterapi.tgl_perawatan,form_fisioterapi.jam_rawat,form_fisioterapi.diagnosa, "+
                    "form_fisioterapi.anamnesa,form_fisioterapi.anjuran,form_fisioterapi.tindakan,form_fisioterapi.evaluasi,form_fisioterapi.suspek,form_fisioterapi.ket_suspek,form_fisioterapi.nip,petugas.nama "+
                    "FROM form_fisioterapi INNER JOIN reg_periksa ON form_fisioterapi.no_rawat = reg_periksa.no_rawat "+ 
                    "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN petugas ON form_fisioterapi.nip = petugas.nip "+
                    "WHERE form_fisioterapi.tgl_perawatan BETWEEN ? AND ? "+ 
                    "ORDER BY form_fisioterapi.tgl_perawatan ");
            }else{
                ps=koneksi.prepareStatement(
                    "SELECT reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur, "+
                    "pasien.jk,pasien.tgl_lahir,form_fisioterapi.tgl_perawatan,form_fisioterapi.jam_rawat,form_fisioterapi.diagnosa, "+
                    ...
                    "FROM form_fisioterapi INNER JOIN reg_periksa ON form_fisioterapi.no_rawat = reg_periksa.no_rawat "+ 
                    "INNER JOIN pasien ON reg_periksa.no_rkm_medis = pasien.no_rkm_medis INNER JOIN petugas ON form_fisioterapi.nip = petugas.nip "+
                    "where form_fisioterapi.tgl_perawatan between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or form_fisioterapi.nip like ? or petugas.nama like ?) "+
                    "order by form_fisioterapi.tgl_perawatan ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("anamnesa"),rs.getString("anjuran"),
                        rs.getString("diagnosa"),rs.getString("tindakan"),rs.getString("evaluasi"),rs.getString("suspek"),rs.getString("ket_suspek"),rs.getString("nip"),
                        rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Anjuran.setText(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            ...
            Evaluasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            KetSuspek.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
    ...
    private void ganti() {
        Sequel.mengedit("form_fisioterapi","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,anamnesa=?,anjuran=?,diagnosa=?,tindakan=?,evaluasi=?,suspek=?,ket_suspek=?,nip=?",14,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
              Anamnesa.getText(),Anjuran.getText(),Diagnosa.getText(),Tindakan.getText(),Evaluasi.getText(),cmbSuspek.getSelectedItem().toString(),KetSuspek.getText(),NIP.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from form_fisioterapi where tgl_perawatan=? and jam_rawat=? and no_rawat=?",3,new String[]{
