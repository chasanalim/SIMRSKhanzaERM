...
public final class RMPenilaianAwalKeperawatanKebidanan extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanKebidanan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.RM","Nama Pasien","J.K.","Agama","Bahasa","Cacat Fisik","Tgl.Lahir","Tgl.Asuhan","Informasi",
            "TD","Nadi","RR","Suhu","GCS","BB","TB","LILA","BMI","TFU","TBJ","Leopoid1","Leopoid2","Leopoid3","Leopoid4","Penurunan","Kontraksi/HIS",
            "Kekuatan","Lamanya","DJJ","Irama","Portio","Pembukaan Serviks","Ketuban","Hodge","Inspekulo","Hasil Inspekulo","CTG","Hasil CTG","USG",
            "Hasil USG","Lakmus","Hasil Lakmus","Pemeriksaan Panggul","Keluhan Utama","Menarche","Lamanya","Banyaknya","Siklus","Ket.Siklus",
            "Masalah Menstruasi","Stts.Menikah","Kali","Usia Kw 1","Stts.Kawin 1","Usia Kw 2","Stts.Kawin 2","Usia Kw 3","Stts.Kawin 3","HPHT",
            "Usia Hamil","TP","Imunisasi","Jml.Imun","G","P","A","Hidup","Riwayat Ginekologi","Obat/Vitamin","Obat/Vitamin Diminum","Merokok",
            "Jml.Rokok","Alkohol","Jml.Alkohol","Obat Tidur","Riwayat KB","Lama KB","Komplikasi KB","Ket.Komplikasi KB","Berhenti KB",
            "Alasan Berhenti KB","Alat Bantu","Ket.Alat Bantu","Prothesa","Keterangan Prothesa","ADL","Stts.Psikologi","Ket.Stts Psikologi",
            "Hubungan Keluarga","Tinggal Dengan","Keterangan Tinggal","Ekonomi","Budaya","Keterangan Budaya","Edukasi","Keterangan Edukasi","R.J.a.1",
            "R.J.a.2","R.J.b","Hasil Penilaian Resiko Jatuh","Dilaporkan","Jam Lapor","Skrining Gizi 1","N1","Skrining Gizi 2","N2","Total Skor",
            "Kondisi Nyeri","Penyebab Nyeri","Ket.Peny Nyeri","Kualitas","Ket.Kualitas","Lokasi","Menyebar","Skala","Durasi","Nyeri Hilang",
            "Ket.Nyeri Hilang","Diberitahukan","Jam Diberitahukan","Diagnosa Kebidanan","Tindakan","NIP","Nama Petugas/Bidan"
        }){
        ...
        Leopoid4.setDocument(new batasInput((byte)10).getKata(Leopoid4));
        TBJ.setDocument(new batasInput((byte)10).getKata(TBJ));
        DJJ.setDocument(new batasInput((byte)10).getKata(DJJ));
        Leopoid1.setDocument(new batasInput((byte)100).getKata(Leopoid1));
        Leopoid2.setDocument(new batasInput((byte)100).getKata(Leopoid2));
        Leopoid3.setDocument(new batasInput((byte)100).getKata(Leopoid3));
        Leopoid4.setDocument(new batasInput((byte)100).getKata(Leopoid4));
        ...
        KeadaanIbu.setDocument(new batasInput((byte)40).getKata(KeadaanIbu));
    ...
    private void initComponents() {
        ...
        KeadaanIbu = new widget.TextBox();
        UsiaAnak = new widget.TextBox();
        ...
        Leopoid1 = new widget.TextBox();
        Leopoid2 = new widget.TextBox();
        Leopoid3 = new widget.TextBox();
        jLabel173 = new widget.Label();
        jLabel174 = new widget.Label();
        Irama = new widget.ComboBox();
        ...
        internalFrame4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 153), 2), "::[ Riwayat Persalinan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        ...
        jLabel99.setBounds(300, 40, 110, 23);
        ...
        BtnKeluarKehamilan.setBounds(500, 160, 100, 30);
        ...
        BtnSimpanRiwayatKehamilan.setBounds(390, 160, 100, 30);

        TempatPersalinan.setHighlighter(null);
        TempatPersalinan.setName("TempatPersalinan"); // NOI18N
        TempatPersalinan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TempatPersalinanActionPerformed(evt);
            }
        });
        ...
        TempatPersalinan.setBounds(420, 40, 180, 23);
        ...
        jLabel109.setBounds(300, 10, 110, 23);
        ...
        Penolong.setBounds(420, 10, 180, 23);
        ...
        jLabel111.setBounds(300, 70, 110, 23);
        ...
        Penyulit.setBounds(420, 70, 180, 23);

        jLabel112.setText("Keadaan Ibu :");
        jLabel112.setName("jLabel112"); // NOI18N
        panelBiasa2.add(jLabel112);
        jLabel112.setBounds(300, 100, 110, 23);

        KeadaanIbu.setHighlighter(null);
        KeadaanIbu.setName("KeadaanIbu"); // NOI18N
        KeadaanIbu.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KeadaanIbuKeyPressed(evt);
            }
        });
        panelBiasa2.add(KeadaanIbu);
        KeadaanIbu.setBounds(420, 100, 180, 23);

        UsiaAnak.setHighlighter(null);
        UsiaAnak.setName("UsiaAnak"); // NOI18N
        UsiaAnak.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                UsiaAnakKeyPressed(evt);
            }
        });
        ...
        KeadaanBayi.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KeadaanBayiKeyPressed(evt);
            }
        });
        panelBiasa2.add(KeadaanBayi);
        KeadaanBayi.setBounds(420, 130, 180, 23);

        jLabel178.setText("Keadaan Bayi :");
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1933));
        ...
        jLabel27.setBounds(230, 610, 40, 23);
        ...
        Informasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Pasien", "Suami", "Keluarga", "Lain-lain" }));
        ...
        jLabel31.setBounds(590, 190, 70, 23);

        Leopoid4.setFocusTraversalPolicyProvider(true);
        Leopoid4.setName("Leopoid4"); // NOI18N
        Leopoid4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Leopoid4KeyPressed(evt);
            }
        });
        FormInput.add(Leopoid4);
        Leopoid4.setBounds(120, 280, 490, 23);

        jLabel32.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel32.setText(" kali/menit");
        jLabel32.setName("jLabel32"); // NOI18N
        FormInput.add(jLabel32);
        jLabel32.setBounds(180, 350, 50, 23);

        jLabel33.setText("TBJ :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(750, 190, 40, 23);
        ...
        FormInput.add(TBJ);
        TBJ.setBounds(790, 190, 60, 23);

        jLabel37.setText("DJJ          :");
        jLabel37.setName("jLabel37"); // NOI18N
        FormInput.add(jLabel37);
        jLabel37.setBounds(40, 350, 70, 23);

        DJJ.setFocusTraversalPolicyProvider(true);
        DJJ.setName("DJJ"); // NOI18N
        DJJ.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DJJActionPerformed(evt);
            }
        });
        ...
        FormInput.add(DJJ);
        DJJ.setBounds(120, 350, 60, 23);

        jLabel39.setText("Bagian Bawah :");
        jLabel39.setName("jLabel39"); // NOI18N
        FormInput.add(jLabel39);
        jLabel39.setBounds(230, 405, 90, 23);
        ...
        Penurunan.setBounds(320, 405, 70, 23);
        ...
        Kontraksi.setBounds(120, 310, 60, 23);

        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel41.setText(" x/10’,");
        jLabel41.setName("jLabel41"); // NOI18N
        FormInput.add(jLabel41);
        jLabel41.setBounds(180, 310, 40, 23);
        ...
        Kekuatan.setBounds(410, 310, 100, 23);

        jLabel42.setText("Kekuatan :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(340, 310, 68, 23);

        jLabel43.setText("Lamanya :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(220, 310, 60, 23);
        ...
        Lamanya.setBounds(280, 310, 60, 23);

        jLabel44.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel44.setText(" cm");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(720, 190, 25, 23);

        jLabel46.setText("Portio :");
        jLabel46.setName("jLabel46"); // NOI18N
        FormInput.add(jLabel46);
        jLabel46.setBounds(400, 405, 40, 23);
        ...
        PembukaanServiks.setBounds(150, 405, 60, 23);

        jLabel48.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel48.setText(" cm ");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(210, 405, 20, 23);

        jLabel49.setText("Ketuban :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(690, 405, 50, 23);
        ...
        Ketuban.setBounds(745, 405, 60, 23);

        jLabel50.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel50.setText("kep/bok");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(810, 405, 60, 23);

        jLabel51.setText("Hodge :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(540, 405, 40, 23);
        ...
        FormInput.add(Hodge);
        Hodge.setBounds(585, 405, 70, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("* HIS           :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(50, 310, 70, 23);

        jLabel55.setText("Hasil :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(260, 460, 38, 23);
        ...
        KeteranganInspekulo.setBounds(300, 460, 175, 23);
        ...
        Inspekulo.setBounds(150, 460, 100, 23);

        jLabel56.setText("Inspekulo :");
        jLabel56.setName("jLabel56"); // NOI18N
        FormInput.add(jLabel56);
        jLabel56.setBounds(70, 460, 80, 23);

        jLabel57.setText("CTG :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(480, 460, 55, 23);
        ...
        FormInput.add(CTG);
        CTG.setBounds(540, 460, 100, 23);

        jLabel58.setText("Hasil :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(640, 460, 38, 23);
        ...
        KeteranganCTG.setBounds(680, 460, 175, 23);

        jLabel61.setText("USG :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(480, 490, 55, 23);
        ...
        StatusKawin1.setBounds(730, 690, 125, 23);

        jLabel62.setText("Hasil :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(640, 490, 38, 23);
        ...
        KeteranganUSG.setBounds(680, 490, 175, 23);

        jLabel63.setText("Lakmus :");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(60, 490, 90, 23);
        ...
        Lakmus.setBounds(150, 490, 100, 23);

        jLabel64.setText("Hasil :");
        jLabel64.setName("jLabel64"); // NOI18N
        FormInput.add(jLabel64);
        jLabel64.setBounds(260, 490, 38, 23);
        ...
        KeteranganLakmus.setBounds(300, 490, 175, 23);

        jLabel65.setText("Pemeriksaan Panggul :");
        jLabel65.setName("jLabel65"); // NOI18N
        FormInput.add(jLabel65);
        jLabel65.setBounds(490, 520, 170, 23);
        ...
        PemeriksaanPanggul.setBounds(660, 520, 195, 23);
        ...
        jSeparator3.setBounds(0, 530, 880, 1);
        ...
        jLabel47.setBounds(0, 550, 125, 20);
        ...
        scrollPane1.setBounds(130, 550, 725, 35);

        jLabel66.setText("Riwayat Perkawinan :");
        jLabel66.setName("jLabel66"); // NOI18N
        FormInput.add(jLabel66);
        jLabel66.setBounds(0, 670, 149, 23);

        jLabel67.setText("Menarche :");
        jLabel67.setName("jLabel67"); // NOI18N
        FormInput.add(jLabel67);
        jLabel67.setBounds(0, 610, 170, 23);
        ...
        jLabel69.setBounds(390, 640, 28, 23);
        ...
        FormInput.add(Lama);
        Lama.setBounds(320, 610, 60, 23);

        jLabel70.setText(" (");
        jLabel70.setName("jLabel70"); // NOI18N
        FormInput.add(jLabel70);
        jLabel70.setBounds(240, 640, 20, 23);

        jLabel71.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel71.setText("tahun,");
        jLabel71.setName("jLabel71"); // NOI18N
        FormInput.add(jLabel71);
        jLabel71.setBounds(650, 690, 45, 23);
        ...
        Siklus.setBounds(170, 640, 60, 23);

        jLabel75.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel75.setText(" hari,");
        jLabel75.setName("jLabel75"); // NOI18N
        FormInput.add(jLabel75);
        jLabel75.setBounds(230, 640, 30, 23);
        ...
        KetSiklus.setBounds(270, 640, 120, 23);

        jLabel76.setText("Riwayat Menstruasi :");
        jLabel76.setName("jLabel76"); // NOI18N
        FormInput.add(jLabel76);
        jLabel76.setBounds(0, 590, 146, 23);

        jLabel78.setText("banyaknya :");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(400, 610, 66, 23);

        jLabel79.setText("lamanya :");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(260, 610, 55, 23);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText(" hari,");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(380, 610, 30, 23);
        ...
        StatusMenikah.setBounds(170, 690, 175, 23);

        jLabel77.setText("Status Menikah :");
        jLabel77.setName("jLabel77"); // NOI18N
        FormInput.add(jLabel77);
        jLabel77.setBounds(0, 690, 170, 23);

        jLabel81.setText("Status :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(670, 690, 50, 23);
        ...
        UsiaKawin1.setBounds(590, 690, 60, 23);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText(" pembalut");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(530, 610, 50, 23);
        ...
        KetSiklus2.setBounds(680, 640, 175, 23);

        jLabel83.setText("Lama Menikah Ke 1 :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(450, 690, 130, 23);

        jLabel84.setText("Lama Menikah Ke 3 :");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(450, 720, 130, 23);
        ...
        UsiaKawin3.setBounds(590, 720, 60, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("tahun,");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(650, 720, 45, 23);

        jLabel86.setText("Status :");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(670, 720, 50, 23);
        ...
        StatusKawin3.setBounds(730, 720, 125, 23);

        jLabel87.setText("Lama Menikah ke 2 :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(0, 720, 170, 23);
        ...
        UsiaKawin2.setBounds(170, 720, 60, 23);
        ...
        StatusKawin2.setBounds(310, 720, 125, 23);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("tahun,");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(230, 720, 50, 23);

        jLabel89.setText("Status :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(260, 720, 50, 23);
        ...
        KaliMenikah.setBounds(350, 690, 60, 23);

        jLabel90.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel90.setText("kali");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(410, 690, 30, 23);

        jLabel91.setText("Riwayat Kehamilan Tetap :");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(0, 750, 175, 23);
        ...
        FormInput.add(HPHT);
        HPHT.setBounds(170, 770, 90, 23);

        jLabel93.setText("Usia Hamil :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(420, 770, 105, 23);
        ...
        UsiaKehamilan.setBounds(530, 770, 60, 23);

        jLabel95.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel95.setText(" mgg");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(590, 770, 60, 23);
        ...
        FormInput.add(TP);
        TP.setBounds(320, 770, 90, 23);

        jLabel97.setText("Riwayat Imunisasi TT :");
        jLabel97.setName("jLabel97"); // NOI18N
        FormInput.add(jLabel97);
        jLabel97.setBounds(660, 770, 110, 23);
        ...
        RiwayatImunisasi.setBounds(770, 770, 80, 23);

        jLabel98.setText("Imunisasi TT :");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(0, 800, 170, 23);
        ...
        JumlahImunisasi.setBounds(170, 800, 70, 23);

        jLabel101.setText("G :");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(280, 800, 40, 23);
        ...
        FormInput.add(G);
        G.setBounds(320, 800, 60, 23);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("kali");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(250, 800, 30, 23);

        jLabel102.setText("P :");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(400, 800, 30, 23);
        ...
        FormInput.add(P);
        P.setBounds(440, 800, 60, 23);

        jLabel103.setText("A :");
        jLabel103.setName("jLabel103"); // NOI18N
        FormInput.add(jLabel103);
        jLabel103.setBounds(540, 800, 30, 23);
        ...
        FormInput.add(A);
        A.setBounds(580, 800, 60, 23);

        jLabel104.setText("Anak Hidup :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(660, 800, 110, 23);
        ...
        Scroll6.setBounds(170, 830, 680, 93);
        ...
        BtnTambahMasalah.setBounds(140, 830, 28, 23);
        ...
        BtnHapusRiwayatPersalinan.setBounds(140, 860, 28, 23);

        jLabel113.setText("Riwayat Ginekologi :");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(560, 960, 144, 23);
        ...
        RiwayatGenekologi.setBounds(710, 960, 145, 23);

        jLabel114.setText("Riwayat KB :");
        jLabel114.setName("jLabel114"); // NOI18N
        FormInput.add(jLabel114);
        jLabel114.setBounds(0, 930, 105, 23);
        ...
        RiwayatKB.setBounds(110, 930, 117, 23);

        jLabel115.setText("Lamanya :");
        jLabel115.setName("jLabel115"); // NOI18N
        FormInput.add(jLabel115);
        jLabel115.setBounds(230, 930, 60, 23);
        ...
        LamanyaKB.setBounds(300, 930, 60, 23);
        ...
        KomplikasiKB.setBounds(440, 930, 100, 23);

        jLabel116.setText("Komplikasi :");
        jLabel116.setName("jLabel116"); // NOI18N
        FormInput.add(jLabel116);
        jLabel116.setBounds(370, 930, 67, 23);
        ...
        KeteranganKomplikasiKB.setBounds(540, 930, 309, 23);

        jLabel117.setText("Kapan Berhenti KB :");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput.add(jLabel117);
        jLabel117.setBounds(60, 960, 110, 23);
        ...
        BerhentiKB.setBounds(170, 960, 60, 23);

        jLabel118.setText("Alasan :");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput.add(jLabel118);
        jLabel118.setBounds(230, 960, 60, 23);
        ...
        AlasanBerhentiKB.setBounds(300, 960, 290, 23);

        jLabel119.setText("Riwayat Kebiasaan :");
        jLabel119.setName("jLabel119"); // NOI18N
        FormInput.add(jLabel119);
        jLabel119.setBounds(0, 990, 143, 23);

        jLabel120.setText("Obat/Vitamin :");
        jLabel120.setName("jLabel120"); // NOI18N
        FormInput.add(jLabel120);
        jLabel120.setBounds(0, 1010, 170, 23);
        ...
        KebiasaanObat.setBounds(170, 1010, 185, 23);
        ...
        KebiasaanMerokok.setBounds(170, 1040, 70, 23);
        ...
        KebiasaanAlkohol.setBounds(450, 1040, 60, 23);
        ...
        KebiasaanJumlahAlkohol.setBounds(530, 1040, 60, 23);

        jLabel124.setText("Alkohol :");
        jLabel124.setName("jLabel124"); // NOI18N
        FormInput.add(jLabel124);
        jLabel124.setBounds(380, 1040, 65, 23);
        ...
        KebiasaanNarkoba.setBounds(770, 1040, 80, 23);

        jLabel126.setText("Obat Tidur/Narkoba :");
        jLabel126.setName("jLabel126"); // NOI18N
        FormInput.add(jLabel126);
        jLabel126.setBounds(650, 1040, 120, 23);
        ...
        AlatBantu.setBounds(120, 1090, 90, 23);
        ...
        KetBantu.setBounds(220, 1090, 220, 23);
        ...
        Prothesa.setBounds(540, 1090, 80, 23);
        ...
        KetProthesa.setBounds(630, 1090, 220, 23);

        jLabel128.setText("Alat Bantu :");
        jLabel128.setName("jLabel128"); // NOI18N
        FormInput.add(jLabel128);
        jLabel128.setBounds(0, 1090, 120, 23);
        ...
        CacatFisik.setBounds(120, 1120, 314, 23);
        ...
        jSeparator5.setBounds(0, 1150, 880, 1);
        ...
        jLabel131.setBounds(10, 1150, 380, 23);
        ...
        StatusPsiko.setBounds(130, 1170, 110, 23);
        ...
        KetPsiko.setBounds(250, 1170, 230, 23);

        jLabel132.setText("Status Psikologis :");
        jLabel132.setName("jLabel132"); // NOI18N
        FormInput.add(jLabel132);
        jLabel132.setBounds(0, 1170, 130, 23);
        ...
        HubunganKeluarga.setBounds(290, 1220, 100, 23);
        ...
        TinggalDengan.setBounds(490, 1220, 110, 23);
        ...
        KetTinggal.setBounds(610, 1220, 85, 23);

        jLabel136.setText("b. Tinggal dengan :");
        jLabel136.setName("jLabel136"); // NOI18N
        FormInput.add(jLabel136);
        jLabel136.setBounds(390, 1220, 100, 23);
        ...
        StatusBudaya.setBounds(370, 1250, 100, 23);
        ...
        KetBudaya.setBounds(480, 1250, 370, 23);

        jLabel139.setText("Edukasi diberikan kepada :");
        jLabel139.setName("jLabel139"); // NOI18N
        FormInput.add(jLabel139);
        jLabel139.setBounds(220, 1280, 140, 23);
        ...
        Edukasi.setBounds(370, 1280, 100, 23);
        ...
        KetEdukasi.setBounds(480, 1280, 370, 23);

        jLabel140.setText("Agama :");
        jLabel140.setName("jLabel140"); // NOI18N
        FormInput.add(jLabel140);
        jLabel140.setBounds(0, 1280, 82, 23);
        ...
        FormInput.add(Agama);
        Agama.setBounds(90, 1280, 110, 23);
        ...
        jLabel145.setBounds(0, 1380, 571, 23);
        ...
        FormInput.add(Lapor);
        Lapor.setBounds(580, 1410, 80, 23);
        ...
        FormInput.add(Hasil);
        Hasil.setBounds(70, 1410, 300, 23);

        jLabel146.setText("Hasil :");
        jLabel146.setName("jLabel146"); // NOI18N
        FormInput.add(jLabel146);
        jLabel146.setBounds(0, 1410, 72, 23);
        ...
        KetLapor.setBounds(770, 1410, 80, 23);

        jLabel147.setText("Dilaporkan kepada dokter ?");
        jLabel147.setName("jLabel147"); // NOI18N
        FormInput.add(jLabel147);
        jLabel147.setBounds(380, 1410, 190, 23);

        jLabel148.setText("Jam dilaporkan :");
        jLabel148.setName("jLabel148"); // NOI18N
        FormInput.add(jLabel148);
        jLabel148.setBounds(680, 1410, 90, 23);
        ...
        Nilai1.setBounds(770, 1460, 80, 23);
        ...
        jLabel150.setBounds(40, 1460, 460, 23);

        jLabel151.setText("Nilai :");
        jLabel151.setName("jLabel151"); // NOI18N
        FormInput.add(jLabel151);
        jLabel151.setBounds(690, 1460, 75, 23);
        ...
        jLabel152.setBounds(40, 1490, 460, 23);
        ...
        FormInput.add(SG2);
        SG2.setBounds(520, 1490, 160, 23);

        jLabel153.setText("Nilai :");
        jLabel153.setName("jLabel153"); // NOI18N
        FormInput.add(jLabel153);
        jLabel153.setBounds(690, 1490, 75, 23);
        ...
        Nilai2.setBounds(770, 1490, 80, 23);

        jLabel154.setText("Total Skor :");
        jLabel154.setName("jLabel154"); // NOI18N
        FormInput.add(jLabel154);
        jLabel154.setBounds(690, 1520, 75, 23);
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(370, 1570, 130, 23);
        ...
        Provokes.setBounds(570, 1570, 130, 23);
        ...
        KetProvokes.setBounds(710, 1570, 146, 23);

        jLabel156.setText("Penyebab :");
        jLabel156.setName("jLabel156"); // NOI18N
        FormInput.add(jLabel156);
        jLabel156.setBounds(510, 1570, 60, 23);
        ...
        jSeparator9.setBounds(360, 1570, 1, 140);
        ...
        Quality.setBounds(430, 1600, 130, 23);
        ...
        KetQuality.setBounds(570, 1600, 280, 23);

        jLabel157.setText("Kualitas :");
        jLabel157.setName("jLabel157"); // NOI18N
        FormInput.add(jLabel157);
        jLabel157.setBounds(370, 1600, 55, 23);

        jLabel158.setText("Wilayah :");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput.add(jLabel158);
        jLabel158.setBounds(370, 1630, 55, 23);

        jLabel159.setText("Menyebar :");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput.add(jLabel159);
        jLabel159.setBounds(690, 1650, 79, 23);
        ...
        Lokasi.setBounds(460, 1650, 220, 23);

        jLabel160.setText("Lokasi :");
        jLabel160.setName("jLabel160"); // NOI18N
        FormInput.add(jLabel160);
        jLabel160.setBounds(390, 1650, 60, 23);
        ...
        SkalaNyeri.setBounds(490, 1680, 70, 23);
        ...
        NyeriHilang.setBounds(130, 1710, 130, 23);
        ...
        KetNyeri.setBounds(270, 1710, 150, 23);

        jLabel167.setText("Nyeri hilang bila :");
        jLabel167.setName("jLabel167"); // NOI18N
        FormInput.add(jLabel167);
        jLabel167.setBounds(0, 1710, 130, 23);
        ...
        PadaDokter.setBounds(630, 1710, 80, 23);
        ...
        KetDokter.setBounds(770, 1710, 80, 23);
        ...
        jLabel168.setText("Diagnosa Kebidanan :");
        jLabel168.setName("jLabel168"); // NOI18N
        FormInput.add(jLabel168);
        jLabel168.setBounds(10, 1750, 120, 23);
        ...
        scrollPane8.setBounds(10, 1770, 400, 143);

        jLabel60.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel60.setText("D. Pemeriksaan Penunjang :");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(30, 430, 170, 23);
        ...
        FormInput.add(TFU);
        TFU.setBounds(660, 190, 60, 23);

        jLabel73.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel73.setText("* Leopoid 1 :");
        jLabel73.setName("jLabel73"); // NOI18N
        FormInput.add(jLabel73);
        jLabel73.setBounds(50, 190, 70, 23);

        jLabel170.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel170.setText("* Leopoid 2 :");
        jLabel170.setName("jLabel170"); // NOI18N
        FormInput.add(jLabel170);
        jLabel170.setBounds(50, 220, 70, 23);

        jLabel171.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel171.setText("* Leopoid 3 :");
        jLabel171.setName("jLabel171"); // NOI18N
        FormInput.add(jLabel171);
        jLabel171.setBounds(50, 250, 70, 23);

        jLabel172.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel172.setText("* Leopoid 4 :");
        jLabel172.setName("jLabel172"); // NOI18N
        FormInput.add(jLabel172);
        jLabel172.setBounds(50, 280, 70, 23);

        Leopoid1.setFocusTraversalPolicyProvider(true);
        Leopoid1.setName("Leopoid1"); // NOI18N
        Leopoid1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Leopoid1KeyPressed(evt);
            }
        });
        FormInput.add(Leopoid1);
        Leopoid1.setBounds(120, 190, 490, 23);

        Leopoid2.setFocusTraversalPolicyProvider(true);
        Leopoid2.setName("Leopoid2"); // NOI18N
        Leopoid2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Leopoid2KeyPressed(evt);
            }
        });
        FormInput.add(Leopoid2);
        Leopoid2.setBounds(120, 220, 490, 23);

        Leopoid3.setFocusTraversalPolicyProvider(true);
        Leopoid3.setName("Leopoid3"); // NOI18N
        Leopoid3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Leopoid3KeyPressed(evt);
            }
        });
        FormInput.add(Leopoid3);
        Leopoid3.setBounds(120, 250, 490, 23);

        jLabel173.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel173.setText("A. Palpasi :");
        jLabel173.setName("jLabel173"); // NOI18N
        FormInput.add(jLabel173);
        jLabel173.setBounds(30, 170, 90, 23);

        jLabel174.setText("Irama :");
        jLabel174.setName("jLabel174"); // NOI18N
        FormInput.add(jLabel174);
        jLabel174.setBounds(220, 350, 80, 23);

        Irama.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Reguler", "Irreguler" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_keperawatan_kebidanan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",117,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Informasi.getSelectedItem().toString(),TD.getText(),
                    Nadi.getText(),RR.getText(),Suhu.getText(),GCS.getText(),BB.getText(),TB.getText(),LILA.getText(),BMI.getText(),Leopoid1.getText(),
                    TFU.getText(),TBJ.getText(),Leopoid2.getText(),Leopoid3.getText(),Leopoid4.getText(),Kontraksi.getText(),Lamanya.getText(),Kekuatan.getText(),DJJ.getText(),
                    Irama.getSelectedItem().toString(),PembukaanServiks.getText(),Penurunan.getText(),Portio.getText(),Ketuban.getText(),Hodge.getText(),Inspekulo.getSelectedItem().toString(),
                    KeteranganInspekulo.getText(),CTG.getSelectedItem().toString(),KeteranganCTG.getText(),USG.getSelectedItem().toString(),KeteranganUSG.getText(),
                    Lakmus.getSelectedItem().toString(),KeteranganLakmus.getText(),PemeriksaanPanggul.getSelectedItem().toString(),KeluhanUtama.getText(),Umur.getText(),
                    Lama.getText(),Banyaknya.getText(),Siklus.getText(),KetSiklus.getSelectedItem().toString(),KetSiklus2.getSelectedItem().toString(),
                    StatusMenikah.getSelectedItem().toString(),KaliMenikah.getText(),UsiaKawin1.getText(),StatusKawin1.getSelectedItem().toString(),UsiaKawin2.getText(),
                    StatusKawin2.getSelectedItem().toString(),UsiaKawin3.getText(),StatusKawin3.getSelectedItem().toString(),Valid.SetTgl(HPHT.getSelectedItem()+""),
                    Valid.SetTgl(TP.getSelectedItem()+""),UsiaKehamilan.getText(),RiwayatImunisasi.getSelectedItem().toString(),JumlahImunisasi.getText(),
                    G.getText(),P.getText(),A.getText(),Hidup.getText(),RiwayatKB.getSelectedItem().toString(),LamanyaKB.getText(),KomplikasiKB.getSelectedItem().toString(),
                    KeteranganKomplikasiKB.getText(),BerhentiKB.getText(),AlasanBerhentiKB.getText(),RiwayatGenekologi.getSelectedItem().toString(),KebiasaanObat.getSelectedItem().toString(),
                    KebiasaanObatDiminum.getText(),KebiasaanMerokok.getSelectedItem().toString(),KebiasaanJumlahRokok.getText(),KebiasaanAlkohol.getSelectedItem().toString(),
                    KebiasaanJumlahAlkohol.getText(),KebiasaanNarkoba.getSelectedItem().toString(),AlatBantu.getSelectedItem().toString(),KetBantu.getText(),Prothesa.getSelectedItem().toString(),KetProthesa.getText(),
                    ADL.getSelectedItem().toString(),StatusPsiko.getSelectedItem().toString(),KetPsiko.getText(),HubunganKeluarga.getSelectedItem().toString(),
                    TinggalDengan.getSelectedItem().toString(),KetTinggal.getText(),Ekonomi.getSelectedItem().toString(),StatusBudaya.getSelectedItem().toString(),
                    KetBudaya.getText(),Edukasi.getSelectedItem().toString(),KetEdukasi.getText(),RJa1.getSelectedItem().toString(),RJa2.getSelectedItem().toString(),
                    RJb.getSelectedItem().toString(),Hasil.getSelectedItem().toString(),Lapor.getSelectedItem().toString(),KetLapor.getText(),
                    SG1.getSelectedItem().toString(),Nilai1.getSelectedItem().toString(),SG2.getSelectedItem().toString(),Nilai2.getSelectedItem().toString(),
                    TotalHasil.getText(),Nyeri.getSelectedItem().toString(),Provokes.getSelectedItem().toString(),KetProvokes.getText(),
                    Quality.getSelectedItem().toString(),KetQuality.getText(),Lokasi.getText(),Menyebar.getSelectedItem().toString(),SkalaNyeri.getSelectedItem().toString(),
                    Durasi.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),PadaDokter.getSelectedItem().toString(),KetDokter.getText(),Masalah.getText(),
        ...
        if(TNoRM.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()>-1){
                if(akses.getkode().equals("Admin Utama")){
                    ...
                    if(KdPetugas.getText().equals(tbObat.getValueAt(tbObat.getSelectedRow(),123).toString())){
                        ganti();
                    }else{
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ps=koneksi.prepareStatement(
                    ...
                    "penilaian_awal_keperawatan_kebidanan.tb,penilaian_awal_keperawatan_kebidanan.bmi,penilaian_awal_keperawatan_kebidanan.lila,penilaian_awal_keperawatan_kebidanan.tfu,penilaian_awal_keperawatan_kebidanan.tbj,penilaian_awal_keperawatan_kebidanan.leopoid1,"+
                    "penilaian_awal_keperawatan_kebidanan.leopoid3,penilaian_awal_keperawatan_kebidanan.leopoid4,penilaian_awal_keperawatan_kebidanan.penurunan,penilaian_awal_keperawatan_kebidanan.his,penilaian_awal_keperawatan_kebidanan.kekuatan,penilaian_awal_keperawatan_kebidanan.lamanya,penilaian_awal_keperawatan_kebidanan.bjj,"+
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",tbObat.getValueAt(tbObat.getSelectedRow(),123).toString());
            param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+tbObat.getValueAt(tbObat.getSelectedRow(),124).toString()+"\nID "+(finger.equals("")?tbObat.getValueAt(tbObat.getSelectedRow(),123).toString():finger)+"\n"+Valid.SetTgl3(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString())); 
            try {
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalKebidananRalan2.jasper","report","::[ Laporan Penilaian Awal Ralan Kebidanan & Kandungan ]::",
                ...
                "penilaian_awal_keperawatan_kebidanan.tb,penilaian_awal_keperawatan_kebidanan.nadi,penilaian_awal_keperawatan_kebidanan.rr,penilaian_awal_keperawatan_kebidanan.suhu,penilaian_awal_keperawatan_kebidanan.gcs,penilaian_awal_keperawatan_kebidanan.bb,"+
                "penilaian_awal_keperawatan_kebidanan.tb,penilaian_awal_keperawatan_kebidanan.bmi,penilaian_awal_keperawatan_kebidanan.lila,penilaian_awal_keperawatan_kebidanan.tfu,penilaian_awal_keperawatan_kebidanan.tbj,penilaian_awal_keperawatan_kebidanan.leopoid1,"+
                "penilaian_awal_keperawatan_kebidanan.leopoid2,penilaian_awal_keperawatan_kebidanan.leopoid3,penilaian_awal_keperawatan_kebidanan.leopoid4,penilaian_awal_keperawatan_kebidanan.penurunan,penilaian_awal_keperawatan_kebidanan.his,penilaian_awal_keperawatan_kebidanan.kekuatan,penilaian_awal_keperawatan_kebidanan.lamanya,penilaian_awal_keperawatan_kebidanan.djj,"+
                "penilaian_awal_keperawatan_kebidanan.irama,penilaian_awal_keperawatan_kebidanan.portio,penilaian_awal_keperawatan_kebidanan.serviks,penilaian_awal_keperawatan_kebidanan.ketuban,penilaian_awal_keperawatan_kebidanan.hodge,penilaian_awal_keperawatan_kebidanan.inspekulo,"+
                "penilaian_awal_keperawatan_kebidanan.ket_inspekulo,penilaian_awal_keperawatan_kebidanan.ctg,penilaian_awal_keperawatan_kebidanan.ket_ctg,penilaian_awal_keperawatan_kebidanan.usg,penilaian_awal_keperawatan_kebidanan.ket_usg,"+
                "penilaian_awal_keperawatan_kebidanan.lakmus,penilaian_awal_keperawatan_kebidanan.ket_lakmus,penilaian_awal_keperawatan_kebidanan.panggul,penilaian_awal_keperawatan_kebidanan.keluhan_utama,penilaian_awal_keperawatan_kebidanan.umur,"+
                "penilaian_awal_keperawatan_kebidanan.lama,penilaian_awal_keperawatan_kebidanan.banyaknya,penilaian_awal_keperawatan_kebidanan.siklus,penilaian_awal_keperawatan_kebidanan.ket_siklus,penilaian_awal_keperawatan_kebidanan.ket_siklus1,"+
                "penilaian_awal_keperawatan_kebidanan.status,penilaian_awal_keperawatan_kebidanan.kali,penilaian_awal_keperawatan_kebidanan.usia1,penilaian_awal_keperawatan_kebidanan.ket1,penilaian_awal_keperawatan_kebidanan.usia2,penilaian_awal_keperawatan_kebidanan.ket2,"+
                "penilaian_awal_keperawatan_kebidanan.usia3,penilaian_awal_keperawatan_kebidanan.ket3,penilaian_awal_keperawatan_kebidanan.hpht,penilaian_awal_keperawatan_kebidanan.usia_kehamilan,penilaian_awal_keperawatan_kebidanan.tp,penilaian_awal_keperawatan_kebidanan.imunisasi,"+
                "penilaian_awal_keperawatan_kebidanan.ket_imunisasi,penilaian_awal_keperawatan_kebidanan.g,penilaian_awal_keperawatan_kebidanan.p,penilaian_awal_keperawatan_kebidanan.a,penilaian_awal_keperawatan_kebidanan.hidup,penilaian_awal_keperawatan_kebidanan.ginekologi,"+
                "penilaian_awal_keperawatan_kebidanan.kebiasaan,penilaian_awal_keperawatan_kebidanan.ket_kebiasaan,penilaian_awal_keperawatan_kebidanan.kebiasaan1,penilaian_awal_keperawatan_kebidanan.ket_kebiasaan1,penilaian_awal_keperawatan_kebidanan.kebiasaan2,"+
    ...
    private void TBJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TBJKeyPressed
        Valid.pindah(evt,TFU,Leopoid2);
    }//GEN-LAST:event_TBJKeyPressed

    private void Leopoid4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Leopoid4KeyPressed
        Valid.pindah(evt,Leopoid3,Kontraksi);
    }//GEN-LAST:event_Leopoid4KeyPressed
    ...
    private void BMIKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BMIKeyPressed
        Valid.pindah(evt,LILA,Leopoid1);
    ...
    private void DJJKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DJJKeyPressed
        Valid.pindah(evt,Kekuatan,Irama);
    ...
    private void PenurunanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenurunanKeyPressed
        Valid.pindah(evt,PembukaanServiks,Portio);
    ...
    private void KontraksiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KontraksiKeyPressed
        Valid.pindah(evt,Leopoid4,Lamanya);
    ...
    private void LamanyaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LamanyaKeyPressed
        Valid.pindah(evt,Kontraksi,Kekuatan);
    ...
    private void PortioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PortioKeyPressed
        Valid.pindah(evt,Penurunan,Hodge);
    ...
    private void PembukaanServiksKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PembukaanServiksKeyPressed
        Valid.pindah(evt,Irama,Penurunan);
    ...
    private void InspekuloKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_InspekuloKeyPressed
        Valid.pindah(evt,Ketuban,KeteranganInspekulo);
    ...
    private void KeteranganUSGKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeteranganUSGKeyPressed
        Valid.pindah(evt,USG,PemeriksaanPanggul);
    ...
    private void PemeriksaanPanggulKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PemeriksaanPanggulKeyPressed
        Valid.pindah(evt,KeteranganUSG,KeluhanUtama);
    ...
    private void HPHTKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_HPHTKeyPressed
        Valid.pindah(evt,UsiaKawin3,TP);
    ...
    private void BtnSimpanRiwayatKehamilanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanRiwayatKehamilanActionPerformed
        ...
        }else if(KeadaanIbu.getText().trim().equals("")){
    ...
    private void PenolongKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenolongKeyPressed
        Valid.pindah(evt,BBPB,TempatPersalinan);
    ...
    private void PenyulitKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PenyulitKeyPressed
        Valid.pindah(evt,TempatPersalinan,KeadaanIbu);
    }//GEN-LAST:event_PenyulitKeyPressed

    private void KeadaanIbuKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeadaanIbuKeyPressed
        Valid.pindah(evt,Penyulit,KeadaanBayi);
    }//GEN-LAST:event_KeadaanIbuKeyPressed

    private void UsiaHamilKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UsiaHamilKeyPressed
        Valid.pindah(evt,UsiaAnak,JenisPersalinan);
    }//GEN-LAST:event_UsiaHamilKeyPressed

    private void BBPBKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BBPBKeyPressed
        Valid.pindah(evt,JenisPersalinan,Penolong);
    ...
    private void TFUKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFUKeyPressed
        Valid.pindah(evt,Leopoid1,TBJ);
    }//GEN-LAST:event_TFUKeyPressed

    private void Leopoid1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Leopoid1KeyPressed
        Valid.pindah(evt,BMI,TFU);
    }//GEN-LAST:event_Leopoid1KeyPressed

    private void Leopoid2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Leopoid2KeyPressed
        Valid.pindah(evt,TBJ,Leopoid3);
    }//GEN-LAST:event_Leopoid2KeyPressed

    private void Leopoid3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Leopoid3KeyPressed
        Valid.pindah(evt,Leopoid2,Leopoid4);
    }//GEN-LAST:event_Leopoid3KeyPressed

    private void IramaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_IramaKeyPressed
       Valid.pindah(evt,DJJ,PembukaanServiks);
    }//GEN-LAST:event_IramaKeyPressed

    private void DJJActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DJJActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_DJJActionPerformed
    ...
    private void UsiaAnakKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_UsiaAnakKeyPressed
        Valid.pindah(evt,JK,UsiaHamil);
    }//GEN-LAST:event_UsiaAnakKeyPressed

    private void TempatPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TempatPersalinanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TempatPersalinanActionPerformed

    private void KeadaanBayiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeadaanBayiKeyPressed
        Valid.pindah(evt,KeadaanIbu,BtnSimpanRiwayatKehamilan);
    }//GEN-LAST:event_KeadaanBayiKeyPressed
    ...
    */
    ...
    private widget.TextBox KeadaanBayi;
    private widget.TextBox KeadaanIbu;
    ...
    private widget.TextBox Leopoid1;
    private widget.TextBox Leopoid2;
    private widget.TextBox Leopoid3;
    private widget.TextBox Leopoid4;
    ...
    private widget.TextBox UsiaAnak;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        rs.getString("no_rawat"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),rs.getString("jk"),rs.getString("agama"),rs.getString("nama_bahasa"),rs.getString("nama_cacat"),rs.getString("tgl_lahir"),rs.getString("tanggal"),rs.getString("informasi"),
                        rs.getString("td"),rs.getString("nadi"),rs.getString("rr"),rs.getString("suhu"),rs.getString("gcs"),rs.getString("bb"),rs.getString("tb"),rs.getString("lila"),rs.getString("bmi"),rs.getString("tfu"),
                        rs.getString("tbj"),rs.getString("leopoid1"),rs.getString("leopoid2"),rs.getString("leopoid3"),rs.getString("leopoid4"),rs.getString("penurunan"),rs.getString("his"),rs.getString("kekuatan"),rs.getString("lamanya"),rs.getString("djj"),rs.getString("irama"),rs.getString("portio"),rs.getString("serviks"),rs.getString("ketuban"),
                        rs.getString("hodge"),rs.getString("inspekulo"),rs.getString("ket_inspekulo"),rs.getString("ctg"),rs.getString("ket_ctg"),rs.getString("usg"),rs.getString("ket_usg"),rs.getString("lakmus"),rs.getString("ket_lakmus"),rs.getString("panggul"),rs.getString("keluhan_utama"),
                        rs.getString("umur"),rs.getString("lama"),rs.getString("banyaknya"),rs.getString("siklus"),rs.getString("ket_siklus"),rs.getString("ket_siklus1"),rs.getString("status"),rs.getString("kali"),rs.getString("usia1"),rs.getString("ket1"),rs.getString("usia2"),rs.getString("ket2"),
                        rs.getString("usia3"),rs.getString("ket3"),rs.getString("hpht"),rs.getString("usia_kehamilan"),rs.getString("tp"),rs.getString("imunisasi"),rs.getString("ket_imunisasi"),rs.getString("g"),rs.getString("P"),
                        rs.getString("a"),rs.getString("hidup"),rs.getString("ginekologi"),rs.getString("kebiasaan"),rs.getString("ket_kebiasaan"),rs.getString("kebiasaan1"),rs.getString("ket_kebiasaan1"),rs.getString("kebiasaan2"),rs.getString("ket_kebiasaan2"),rs.getString("kebiasaan3"),rs.getString("kb"),
                        rs.getString("ket_kb"),rs.getString("komplikasi"),rs.getString("ket_komplikasi"),rs.getString("berhenti"),rs.getString("alasan"),rs.getString("alat_bantu"),rs.getString("ket_bantu"),rs.getString("prothesa"),
                        rs.getString("ket_pro"),rs.getString("adl"),rs.getString("status_psiko"),rs.getString("ket_psiko"),rs.getString("hub_keluarga"),rs.getString("tinggal_dengan"),rs.getString("ket_tinggal"),rs.getString("ekonomi"),
                        rs.getString("budaya"),rs.getString("ket_budaya"),rs.getString("edukasi"),rs.getString("ket_edukasi"),rs.getString("berjalan_a"),rs.getString("berjalan_b"),rs.getString("berjalan_c"),rs.getString("hasil"),rs.getString("lapor"),
                        rs.getString("ket_lapor"),rs.getString("sg1"),rs.getString("nilai1"),rs.getString("sg2"),rs.getString("nilai2"),rs.getString("total_hasil"),rs.getString("nyeri"),rs.getString("provokes"),rs.getString("ket_provokes"),rs.getString("quality"),
                        rs.getString("ket_quality"),rs.getString("lokasi"),rs.getString("menyebar"),rs.getString("skala_nyeri"),rs.getString("durasi"),rs.getString("nyeri_hilang"),rs.getString("ket_nyeri"),rs.getString("pada_dokter"),rs.getString("ket_dokter"),
                        rs.getString("masalah"),rs.getString("tindakan"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Leopoid1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),21).toString());
            Leopoid2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            Leopoid3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
            Leopoid4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            Penurunan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            Kontraksi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            Kekuatan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString()); 
            Lamanya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            DJJ.setText(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString()); 
            Irama.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            Portio.setText(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString()); 
            PembukaanServiks.setText(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString()); 
            Ketuban.setText(tbObat.getValueAt(tbObat.getSelectedRow(),33).toString()); 
            Hodge.setText(tbObat.getValueAt(tbObat.getSelectedRow(),34).toString()); 
            Inspekulo.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString()); 
            KeteranganInspekulo.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            CTG.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),37).toString()); 
            KeteranganCTG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),38).toString());
            USG.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),39).toString()); 
            KeteranganUSG.setText(tbObat.getValueAt(tbObat.getSelectedRow(),40).toString()); 
            ...
            Siklus.setText(tbObat.getValueAt(tbObat.getSelectedRow(),48).toString());
            KetSiklus.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),49).toString());
            KetSiklus2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),50).toString());
            StatusMenikah.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),51).toString());
            KaliMenikah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),52).toString());
            UsiaKawin1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),53).toString());
            StatusKawin1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),54).toString());
            UsiaKawin2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),55).toString());
            StatusKawin2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),56).toString());
            UsiaKawin3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),57).toString());
            StatusKawin3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),58).toString());
            UsiaKehamilan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),60).toString());
            RiwayatImunisasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),62).toString());
            JumlahImunisasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),63).toString());
            G.setText(tbObat.getValueAt(tbObat.getSelectedRow(),64).toString());
            P.setText(tbObat.getValueAt(tbObat.getSelectedRow(),65).toString());
            A.setText(tbObat.getValueAt(tbObat.getSelectedRow(),66).toString());
            Hidup.setText(tbObat.getValueAt(tbObat.getSelectedRow(),67).toString());
            RiwayatGenekologi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),68).toString());
            KebiasaanObat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),69).toString());
            KebiasaanObatDiminum.setText(tbObat.getValueAt(tbObat.getSelectedRow(),70).toString());
            KebiasaanMerokok.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),71).toString());
            KebiasaanJumlahRokok.setText(tbObat.getValueAt(tbObat.getSelectedRow(),72).toString());
            KebiasaanAlkohol.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),73).toString());
            KebiasaanJumlahAlkohol.setText(tbObat.getValueAt(tbObat.getSelectedRow(),74).toString());
            KebiasaanNarkoba.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),75).toString());
            RiwayatKB.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),76).toString());
            LamanyaKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),77).toString());
            KomplikasiKB.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),78).toString());
            KeteranganKomplikasiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),79).toString());
            BerhentiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),80).toString());
            AlasanBerhentiKB.setText(tbObat.getValueAt(tbObat.getSelectedRow(),81).toString());
            AlatBantu.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),82).toString());
            KetBantu.setText(tbObat.getValueAt(tbObat.getSelectedRow(),83).toString());
            Prothesa.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),84).toString());
            KetProthesa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),85).toString());
            ADL.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),86).toString());
            StatusPsiko.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),87).toString());
            KetPsiko.setText(tbObat.getValueAt(tbObat.getSelectedRow(),88).toString());
            HubunganKeluarga.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),89).toString());
            TinggalDengan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),90).toString());
            KetTinggal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),91).toString());
            Ekonomi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),92).toString());
            StatusBudaya.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),93).toString());
            KetBudaya.setText(tbObat.getValueAt(tbObat.getSelectedRow(),94).toString());
            Edukasi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),95).toString());
            KetEdukasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),96).toString());
            RJa1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),97).toString());
            RJa2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),98).toString());
            RJb.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),99).toString());
            ...
            SG1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),103).toString());
            Nilai1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),104).toString());
            SG2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),105).toString());
            Nilai2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),106).toString());
            TotalHasil.setText(tbObat.getValueAt(tbObat.getSelectedRow(),107).toString());
            Nyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),108).toString());
            Provokes.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),109).toString());
            KetProvokes.setText(tbObat.getValueAt(tbObat.getSelectedRow(),110).toString());
            Quality.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),111).toString());
            KetQuality.setText(tbObat.getValueAt(tbObat.getSelectedRow(),112).toString());
            Lokasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),113).toString());
            Menyebar.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),114).toString());
            SkalaNyeri.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),115).toString());
            Durasi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),116).toString());
            NyeriHilang.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),117).toString());
            KetNyeri.setText(tbObat.getValueAt(tbObat.getSelectedRow(),118).toString());
            PadaDokter.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),119).toString());
            KetDokter.setText(tbObat.getValueAt(tbObat.getSelectedRow(),120).toString());
            Masalah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),121).toString());
            Tindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),122).toString());
            tampilPersalinan();
            Valid.SetTgl2(TglAsuhan,tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Valid.SetTgl2(HPHT,tbObat.getValueAt(tbObat.getSelectedRow(),59).toString());
            Valid.SetTgl2(TP,tbObat.getValueAt(tbObat.getSelectedRow(),61).toString());
        }
    }
    ...
    private void getMasalah() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            MasalahKebidanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),121).toString());
            TindakanKebidanan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),122).toString());
            Valid.tabelKosong(tabModeRiwayatKehamilan2);
            try {
                ps=koneksi.prepareStatement("select * from riwayat_persalinan_pasien where riwayat_persalinan_pasien.no_rkm_medis=? order by riwayat_persalinan_pasien.usia_anak");
                try {
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_awal_keperawatan_kebidanan","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,lila=?,bmi=?,leopoid1=?,tfu=?,tbj=?,leopoid2=?,leopoid3=?,leopoid4=?,his=?,lamanya=?,kekuatan=?," +
                "djj=?,irama=?,serviks=?,penurunan=?,portio=?,ketuban=?,hodge=?,inspekulo=?,ket_inspekulo=?,ctg=?,ket_ctg=?,usg=?,ket_usg=?,lakmus=?,ket_lakmus=?,panggul=?,keluhan_utama=?," +
                "umur=?,lama=?,banyaknya=?,siklus=?,ket_siklus=?,ket_siklus1=?,status=?,kali=?,usia1=?,ket1=?,usia2=?,ket2=?,usia3=?,ket3=?,hpht=?,tp=?,usia_kehamilan=?,imunisasi=?," +
                "ket_imunisasi=?,g=?,p=?,a=?,hidup=?,kb=?,ket_kb=?,komplikasi=?,ket_komplikasi=?,berhenti=?,alasan=?,ginekologi=?,kebiasaan=?,ket_kebiasaan=?,kebiasaan1=?,ket_kebiasaan1=?," +
                "kebiasaan2=?,ket_kebiasaan2=?,kebiasaan3=?,alat_bantu=?,ket_bantu=?,prothesa=?,ket_pro=?,adl=?,status_psiko=?,ket_psiko=?,hub_keluarga=?,tinggal_dengan=?,ket_tinggal=?," +
                "ekonomi=?,budaya=?,ket_budaya=?,edukasi=?,ket_edukasi=?,berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,sg1=?,nilai1=?,sg2=?,nilai2=?,total_hasil=?,nyeri=?," +
                "provokes=?,ket_provokes=?,quality=?,ket_quality=?,lokasi=?,menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,masalah=?,tindakan=?,nip=?",118,new String[]{
                TNoRw.getText(),Valid.SetTgl ( TglAsuhan.getSelectedItem ()+ "" )+ " " + TglAsuhan.getSelectedItem().toString().substring( 11, 19 ),Informasi.getSelectedItem().toString(),TD.getText(),
                Nadi.getText(),RR.getText(),Suhu.getText(),GCS.getText(),BB.getText(),TB.getText(),LILA.getText(),BMI.getText(),Leopoid1.getText(),TFU.getText(),TBJ.getText(),Leopoid2.getText(),
                Leopoid3.getText(),Leopoid4.getText(),Kontraksi.getText(),Lamanya.getText(),Kekuatan.getText(),DJJ.getText(),Irama.getSelectedItem().toString(),PembukaanServiks.getText(),
                Penurunan.getText(),Portio.getText(),Ketuban.getText(),Hodge.getText(),Inspekulo.getSelectedItem().toString(),KeteranganInspekulo.getText(),CTG.getSelectedItem().toString(),
                KeteranganCTG.getText(),USG.getSelectedItem().toString(),KeteranganUSG.getText(),Lakmus.getSelectedItem().toString(),KeteranganLakmus.getText(),PemeriksaanPanggul.getSelectedItem().toString(),
                KeluhanUtama.getText(),Umur.getText(),Lama.getText(),Banyaknya.getText(),Siklus.getText(),KetSiklus.getSelectedItem().toString(),KetSiklus2.getSelectedItem().toString(),
                StatusMenikah.getSelectedItem().toString(),KaliMenikah.getText(),UsiaKawin1.getText(),StatusKawin1.getSelectedItem().toString(),UsiaKawin2.getText(),StatusKawin2.getSelectedItem().toString(),
                UsiaKawin3.getText(),StatusKawin3.getSelectedItem().toString(),Valid.SetTgl ( HPHT.getSelectedItem ()+ "" ),Valid.SetTgl ( TP.getSelectedItem ()+ "" ),UsiaKehamilan.getText(),
                RiwayatImunisasi.getSelectedItem().toString(),JumlahImunisasi.getText(),G.getText(),P.getText(),A.getText(),Hidup.getText(),RiwayatKB.getSelectedItem().toString(),LamanyaKB.getText(),
                KomplikasiKB.getSelectedItem().toString(),KeteranganKomplikasiKB.getText(),BerhentiKB.getText(),AlasanBerhentiKB.getText(),RiwayatGenekologi.getSelectedItem().toString(),
                KebiasaanObat.getSelectedItem().toString(),KebiasaanObatDiminum.getText(),KebiasaanMerokok.getSelectedItem().toString(),KebiasaanJumlahRokok.getText(),KebiasaanAlkohol.getSelectedItem().toString(),
                KebiasaanJumlahAlkohol.getText(),KebiasaanNarkoba.getSelectedItem().toString(),AlatBantu.getSelectedItem().toString(),KetBantu.getText(),Prothesa.getSelectedItem().toString(),KetProthesa.getText(),
                ADL.getSelectedItem().toString(),StatusPsiko.getSelectedItem().toString(),KetPsiko.getText(),HubunganKeluarga.getSelectedItem().toString(),TinggalDengan.getSelectedItem().toString(),
                KetTinggal.getText(),Ekonomi.getSelectedItem().toString(),StatusBudaya.getSelectedItem().toString(),KetBudaya.getText(),Edukasi.getSelectedItem().toString(),KetEdukasi.getText(),
                RJa1.getSelectedItem().toString(),RJa2.getSelectedItem().toString(),RJb.getSelectedItem().toString(),Hasil.getSelectedItem().toString(),Lapor.getSelectedItem().toString(),KetLapor.getText(),
                ...
                SkalaNyeri.getSelectedItem().toString(),Durasi.getText(),NyeriHilang.getSelectedItem().toString(),KetNyeri.getText(),PadaDokter.getSelectedItem().toString(),KetDokter.getText(),Masalah.getText(),
